...
var ue_id = 'X1VV16GWPAT7S8ZESC5G',
    ue_url,
    ue_navtiming = 1,
    ue_mid = 'A1EVAM02EL8SFB',
    ue_sid = '133-0822304-5101768',
    ue_sn = 'www.imdb.com',
    ...
    ue_rpl_ns = 'cel-rpl',
    ue_ddq = 1,
    ue_fpf = '//fls-na.amazon.com/1/batch/1/OP/A1EVAM02EL8SFB:133-0822304-5101768:X1VV16GWPAT7S8ZESC5G$uedata=s:',
    ue_sbuimp = 1,
    ue_ibft = 0,
    ue_fnt = 0,
...
<!-- 5h -->
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 9530)</script> 
...
<script>
  ...
  <script>(function(t){ (t.events = t.events || {})["csm_head_pre_title"] = new Date().getTime(); })(IMDbTimer);</script>
        <title>Dark Waters - Awards - IMDb</title>
...
<script>
    if (typeof uex == 'function') {
      uex("ld", "LoadTitle", {wb: 1});
        ...
        <link rel="canonical" href="https://www.imdb.com/title/tt9071322/awards" />
        <meta property="og:url" content="http://www.imdb.com/title/tt9071322/awards" />
...
<script>
    if (typeof uex == 'function') {
      uex("ld", "LoadIcons", {wb: 1});
        ...
        <meta property="subpageType" content="awards" />
    ...
    <meta property='fb:app_id' content='115109575169727' />
      ...
      <meta property='og:title' content="Dark Waters - IMDb" />
    <meta property='og:site_name' content='IMDb' />
    <meta name="title" content="Dark Waters - IMDb" />
        <meta name="description" content="Dark Waters Awards and Nominations" />
        <meta property="og:description" content="Dark Waters Awards and Nominations" />
        <meta name="keywords" content="Dark Waters, Awards, Nominations, Oscars, MTV Movie Awards, Emmys, Won, Winner, Nominated, Nominee" />
        <meta name="request_id" content="X1VV16GWPAT7S8ZESC5G" />
...
<!-- h=ics-c52xl-10-1b-4ed7b7ea.us-east-1 -->

            <link rel="stylesheet" type="text/css" href="https://m.media-amazon.com/images/S/sash/ORKBqo-hy5-J3jM.css" />
...
ad_utils.set_slots_on_page({ 'injected_billboard':1, 'inline80':1, 'injected_navstrip':1, 'sis_pixel':1, 'bottom_ad':1, 'top_ad':1, 'top_rhs':1, 'btf_rhs2':1, 'rhs_cornerstone':1 });
}
...
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 2729)</script>
    ...
    <body id="styleguide-v2" class="fixed">
            <img height="1" width="1" style='display:none;visibility:hidden;' src='//fls-na.amazon.com/1/batch/1/OP/A1EVAM02EL8SFB:133-0822304-5101768:X1VV16GWPAT7S8ZESC5G$uedata=s:%2Frd%2Fuedata%3Fstaticb%26id%3DX1VV16GWPAT7S8ZESC5G:0' alt="" onload="window.ue_sbl && window.ue_sbl();"/>
...
if (window.csa) {
    csa("Config", {
        ...
        'CacheDetection.RequestID': "X1VV16GWPAT7S8ZESC5G",
        'CacheDetection.Callback': window.ue && ue.reset,
        'LCP.elementDedup': 1
    });

    csa("Events")("setEntity", {
        page: {requestId: "X1VV16GWPAT7S8ZESC5G", meaningful: "interactive"},
        session: {id: "133-0822304-5101768"}
    });
}
...
<script>
    setTimeout(function() {
        ...
        el.src="https://s.amazon-adsystem.com/iu3?d=imdb.com&a1=&a2=0101d82c558af6c34dbf39e32cb0788790efd84c2f4cb0517e9ad23bcf32f3f223b5&cb=104108246433&pId=tt9071322&r=1&rP=https%3A%2F%2Fwww.imdb.com%2Ftitle%2Ftt9071322%2Fawards%3Fref_%3Dtt_awd&encoding=server&prid=0101b8a06a905ea1b08140b84a5449affa998d5e60d1446517cfff313ec56b5b3acd";
        el.onload = function() {
            if (typeof uex == 'function') {
                uex("ld", "LoadSis", {wb: 1});
            }
...
ad_utils.set_aax_instrumentation_pixel_url('TOP_AD', 'https://aax-us-east.amazon-adsystem.com/x/px/QkS-yVNffQfyWGrgN1paK1wAAAF8EGnKcAEAAADKAa1-aKg/');
}
if (ad_utils.inject_serverside_ad) {
ad_utils.inject_serverside_ad('top_ad', ' <script>document.defaultAd = {h:0,w:0}; document.ad = document.defaultAd;<\/script>\n<script id=\"video-event-handlers\">\n (function(window, document) {\n let SLOT_NAME = \'top_ad\';\n let videoTargetMap = new Map(); \n let validPlayIndicatorEvents = [\'loadstart\', \'play\'];\n\n function makeId() {\n return Math.random().toString(36).substr(2, 16);\n }\n\n function handleVideoEvent(event) {\n let videoTarget = event.target;\n let eventType = event.type;\n let timestamp = Date.now();\n\n if (videoTarget.nodeName !== \'VIDEO\' || videoTarget.loop) {\n return;\n }\n\n if (!videoTargetMap.has(videoTarget)) {\n let id = makeId();\n videoTargetMap.set(videoTarget, {\n id: id\n });\n videoTarget.id = id;\n }\n\n let videoTargetEventMap = videoTargetMap.get(videoTarget);\n videoTargetEventMap[eventType] = timestamp;\n\n if (eventType === \'ended\') {\n let firedEvents = Object.keys(videoTargetEventMap);\n let hasMatchingPlayEvent = firedEvents.some(function(evt) {\n return validPlayIndicatorEvents.includes(evt);\n });\n if (!hasMatchingPlayEvent) return;\n }\n\n let evt = {\n type: eventType,\n dispatcher: \'video-handler\',\n documentAdString: JSON.stringify(document.ad),\n slotName: SLOT_NAME,\n targetElementId: videoTargetEventMap.id,\n timestamp: timestamp\n };\n\n parent.postMessage(evt, parent.origin);\n }\n\n document.addEventListener(\'loadstart\', handleVideoEvent, true);\n document.addEventListener(\'play\', handleVideoEvent, true);\n document.addEventListener(\'pause\', handleVideoEvent, true);\n document.addEventListener(\'ended\', handleVideoEvent, true);\n })(window, document);\n<\/script>\n <!DOCTYPE html><html><body><style class=\"imdb-adtech-global-css\">body{overflow-x:hidden}</style><script>void 0===parent.sim&&top&&top.generic&&top.generic.monitoring&&top.generic.monitoring.set_partner&&top.generic.monitoring.set_partner(window,\"1P\");<\/script><script type=\"text/javascript\">function makeWrapBackgroundStylesCss(a,e){var t=\"(min-width: \"+a+\"px)\",r=\"(max-width: \"+e+\"px)\",n=minWidthToImageMap[a],i=e&&\"\"!==e?\"@media screen and \"+t+\" and \"+r+\" { \":\"@media screen and (min-width: \"+a+\"px) {\";return i+WRAP_BACKGROUND_CSS_SELECTOR+\" {background: url(\"+n+\") scroll top no-repeat #000000 !important;\\n\"+scrollBackgroundPositionYCss+\"}}\\n\"}function makeDocumentAdWrapStyle(){if(isStaticBackUpDevice)return null;return null}var WRAP_BACKGROUND_CSS_SELECTOR=\"#ipc-wrap-background-id, #wrapper\",NAVBAR_HEIGHT=56,size=\"970x250\",wrapBackgroundStylesCss=\"\",scrollBackgroundPositionYStyle=\"background-position-y: -\"+NAVBAR_HEIGHT+\"px !important;\",scrollBackgroundPositionYCss=scrollBackgroundPositionYStyle,hasWrapImage=!1,minWidthToImageMap={300:\"\",768:\"\",1024:\"\",1280:\"\"},BACKGROUND_STYLES_300_767=makeWrapBackgroundStylesCss(\"300\",\"767\"),BACKGROUND_STYLES_768_1023=makeWrapBackgroundStylesCss(\"768\",\"1023\"),BACKGROUND_STYLES_1024=makeWrapBackgroundStylesCss(\"1024\",\"\"),BACKGROUND_STYLES_1024_1279=makeWrapBackgroundStylesCss(\"1024\",\"1279\"),BACKGROUND_STYLES_1280=makeWrapBackgroundStylesCss(\"1280\",\"\"),ua=navigator.userAgent.toLowerCase(),isIpad=ua.indexOf(\"ipad\")>-1||ua.indexOf(\"macintosh\")>-1&&\"ontouchend\"in document,isIe=/MSIE|Trident\\/\\d+/.test(navigator.userAgent),isStaticBackUpDevice=isIe||isIpad,wrapColor=\"#000000\";hasWrapImage||!wrapColor||\"970x250\"!==size&&\"300x250\"!==size||(wrapBackgroundStylesCss+=\"\\n\"+WRAP_BACKGROUND_CSS_SELECTOR+\" { background-color: \"+wrapColor+\";}\\n\"),wrapBackgroundStylesCss.length>0&&parent.generic.add_css_style(wrapBackgroundStylesCss,\"wrap-background-styles\");var iframe=window.frameElement,wrapper=iframe.parentNode;iframe.style.position=\"relative\",data={height:250,exheight:500},function(){window.maximize=function(){wrapper.style.height=data.height+\"px\",iframe.style.zIndex=10,iframe.style.height=data.exheight+\"px\",top.document.body.className=top.document.body.className},window.minimize=function(){wrapper.style.height=\"\",iframe.style.zIndex=\"\",iframe.style.height=data.height+\"px\"}}(),document.ad={aid:\"\",cid:\"\",w:970,h:250,bb:1};var documentAdWrap=\"function\"==typeof makeDocumentAdWrapStyle?makeDocumentAdWrapStyle():void 0;documentAdWrap&&(document.ad.wrap=documentAdWrap),parent.ad_utils.expand_ad(iframe),parent.ad_utils.expand_ad(this.frameElement);<\/script><\!-- aid : 1848988770301 : cid : 5745144100401 : template : IMDb Tarnhelm-1.406 --\><\!-- NO [METADATA] --\><\!-- Third party Impression Tracking --\><img src=\"https://bs.serving-sys.com/Serving/adServer.bs?cn=display&amp;c=19&amp;pli=1077057105&amp;gdpr=&amp;gdpr_consent=&amp;adid=1084725978&amp;ord=842,334,004,649,033,591&amp;ctrl=1073885880&amp;impid=RL7JU199B.JYauA3WlorXA\" border=\"0\" width=\"0\" height=\"0\" style=\"display:none;\"><img src=\"https://s.amazon-adsystem.com/iui3?d=forester-did&amp;ex-fargs=%3Fid%3Dae721e3c-16b9-927c-d4ef-3a67bcfd6f35%26type%3D12%26m%3D1&amp;ex-fch=416613&amp;ex-src=https://www.imdb.com/&amp;ex-hargs=v%3D1.0%3Bc%3D1315694470001%3Bp%3DAE721E3C-16B9-927C-D4EF-3A67BCFD6F35\" border=\"0\" width=\"0\" height=\"0\" style=\"display:none;\"><div id=\"custom_html\" style=\"display:none;\"><script>!function(){function e(t,n,a){function r(i,d){if(!n[i]){if(!t[i]){var c=\"function\"==typeof require&&require;if(!d&&c)return c(i,!0);if(o)return o(i,!0);var p=new Error(\"Cannot find module \'\"+i+\"\'\");throw p.code=\"MODULE_NOT_FOUND\",p}var s=n[i]={exports:{}};t[i][0].call(s.exports,function(e){var n=t[i][1][e];return r(n||e)},s,s.exports,e,t,n,a)}return n[i].exports}for(var o=\"function\"==typeof require&&require,i=0;i<a.length;i++)r(a[i]);return r}return e}()({1:[function(e,t,n){\"use strict\";function a(e){if(!parent.document.getElementById(\"vw-styles\")){var t=e,n=parent.document.createTextNode(t),a=parent.document.createElement(\"style\");a.type=\"text/css\",a.id=\"vw-styles\",a.appendChild(n),parent.document.head.appendChild(a)}}function r(){var e=parent.document.getElementById(\"vw-styles\");e&&e.parentNode.removeChild(e),l.classList.remove(\"vw-expanded\"),l.classList.remove(\"vw-collapsed\")}var o=navigator.userAgent.toLowerCase(),i=o.indexOf(\"ipad\")>-1||o.indexOf(\"macintosh\")>-1&&\"ontouchend\"in document,d=!parent.document.getElementById(\"top_ad\"),c=[\"billboard\"],p=568,s=248,l=null,u=!1,m={expanded:!1,init:function(){var e=this;if(!parent.Tarnhelm||i||u)return!1;c.forEach(function(e){return parent.Tarnhelm.getAdByName(e)?void 0:!1}),l=parent.document.getElementById(\"inline20_wrapper\")||parent.document.getElementById(\"top_ad_wrapper\");var t=window.top.matchMedia(\"(max-width: 1023px)\");return t.addListener(function(t){d&&t.matches&&(e.expanded&&(e.setCollapsed(),parent.Tarnhelm.triggerTandemAction({actionName:\"route\",data:{rotatorConfigs:[{name:\"main-rotator\",index:1}]},adName:\"billboard\"})),r())}),a(\"\\n body {\\n overflow-x: hidden;\\n }\\n .ipc-page-grid, #pagecontent {\\n position: relative;\\n }\\n #top_ad_wrapper {\\n padding-top: 12px !important;\\n margin-bottom: 24px !important;\\n }\\n #inline20_wrapper, #top_ad_wrapper {\\n z-index: 0 !important;\\n -webkit-transition: height .5s cubic-bezier(.215,.61,.355,1);\\n transition:height .5s cubic-bezier(.215,.61,.355,1);\\n }\\n .vw-expanded{\\n height: \".concat(p,\"px !important;\\n }\\n .vw-collapsed{\\n height: \").concat(s,\"px !important;\\n }\\n \")),this.setFrequencyCapping(),u=!0},track:function(e){if(\"string\"==typeof e||\"number\"==typeof e){var t=\"string\"==typeof e?e:\"adCustomAction\"+e,n=window.getClickTracker;if(!n)try{n=parent.Tarnhelm.getAdByName(c[0]).getContainerFrame().contentWindow.getClickTracker}catch(a){}n&&\"function\"==typeof n?(new Image).src=n(t):parent.Tarnhelm.log(\"couldn\'t track \"+t+\", getClickTracker function not found\")}},setFrequencyCapping:function(){var e,t=window.ad_utils||parent.ad_utils,n=\"file:\"===window.location.protocol?Date.now():null===(e=document.ad)||void 0===e?void 0:e.cid,a=t.fp||null;a&&a.should_autoplay(n)?(this.setExpanded(),parent.Tarnhelm.triggerTandemAction({actionName:\"route\",data:{rotatorConfigs:[{name:\"main-rotator\",index:2}]},adName:\"billboard\"}),a.log_autoplay(n)):(this.setCollapsed(),parent.Tarnhelm.triggerTandemAction({actionName:\"route\",data:{rotatorConfigs:[{name:\"main-rotator\",index:1}]},adName:\"billboard\"}))},setCollapsed:function(){l.classList.remove(\"vw-expanded\"),l.classList.add(\"vw-collapsed\"),this.expanded=!1},setExpanded:function(){l.classList.remove(\"vw-collapsed\"),l.classList.add(\"vw-expanded\"),this.expanded=!0},dateCheckedActions:function(){for(var e=new URLSearchParams(parent.location.search).get(\"simulatedDate\"),t=Date.parse(e)||Date.now(),n=arguments.length,a=new Array(n),r=0;n>r;r++)a[r]=arguments[r];var o=a.map(function(e){return Date.parse(e.date)||0}),i=o.sort(function(e,t){return t-e}).find(function(e){return t>=e});a.forEach(function(e){var t=Date.parse(e.date)||0;t===i&&setTimeout(function(){parent.Tarnhelm.triggerGlobalAction(e)},1)})}};parent.CustomScript=m},{}]},{},[1]);<\/script></div><style>*{box-sizing:border-box}.graphic>img{position:absolute;top:0;left:0}.graphic>.ad-hover,.graphic>.hover{opacity:0;transition:opacity .15s linear}.app:hover .graphic>.ad-hover,.graphic:hover>.hover{opacity:1}</style><app class=\"app\"></app><script type=\"text/javascript\">function setupIEBackgroundClick(t,o){function a(t){return t.replace(/[-\\/\\\\^$*+?.()|[\\]{}]/g,\"\\\\$&\")}function e(t,o){if(!t||!t.className||\"\"===t.className)return!1;var a=new RegExp(\"\\\\s\"+o+\"\\\\s\");return(\" \"+t.className+\" \").match(a)?!0:!1}function i(t){for(var a=t;a.nodeName&&\"BODY\"!==a.nodeName;){if(e(a,s)||a===o)return a;a=a.parentElement}return null}var n=\"Microsoft Internet Explorer\"===navigator.appName,s=\"click-target\";if(s=a(s),n&&document.documentMode<8){t=t||document.getElementById(\"ad\"),o=o||document.getElementById(\"link\");var c=o.href,d=o.target,r=970,u=250;u=142,o.style.height=u+\"px\",o.style.width=r+\"px\",t.onclick=function(){return i(window.event.srcElement)?!0:void window.open(c,d)},t.style.cursor=\"pointer\"}}function pushEventType(t){var o=getClickTracker(t);adData.trackingHash[t]=o}var DO_NOTHING=function(){},isSecure=function(t){return/s/.test(t.protocol)},isInternalUrl=function(t){if(t){var o=/^((?:https?:)\\/\\/)?([\\w\\-\\.]+(?::[0-9]+)?)\\/?(.*)$/,a=t.match(o),e=a[2];return/\\.amazon\\.com(:.*)?$/.test(e)}return!1},forEach=function(t,o){for(var a=0,e=t.length;e>a;a++)o(t[a],a,t)},getElementById=function(t){return document.getElementById(t)},getElementsByClassName=function(t){if(document.getElementsByClassName)return document.getElementsByClassName(t);if(document.querySelectorAll)return document.querySelectorAll(\".\"+t);if(document.evaluate){for(var o,a=\".//*[contains(concat(\' \', @class, \' \'), \' \"+t+\" \')]\",e=document.evaluate(a,document,null,0,null),i=[];o=e.iterateNext();)i.push(o);return i}for(var e=document.getElementsByTagName(\"*\"),a=new RegExp(\"(^|\\\\s)\"+t+\"(\\\\s|$)\"),i=[],o=0;o<e.length;o++)a.test(e[o].className)&&i.push(e[o]);return i},getQueryString=function(t,o){var a=[];for(var e in t)a.push(e+\"=\"+t[e]);var i=a.join(\"&\");return o?encodeURIComponent(i):i},fadeStart,fadeElement=function(t,o,a,e){t.style.visibility=\"visible\";var i=new Date;fadeStart=fadeStart||i,e=e||300;var n=Math.min((i-fadeStart)/e,1);o||(n=1-n),setOpacity(t,n),o&&1>n||!o&&n>0?setTimeout(function(){fadeElement(t,o,a,e)},25):(fadeStart=null,t.style.filter=\"\",a&&a())},setOpacity=function(t,o){var a=t.style;a.display=\"block\",a.opacity=a.mozOpacity=o,a.filter=\"alpha(opacity=\"+100*o+\")\"},setBackgroundImage=function(t,o){t.style.backgroundImage=\"url(\"+o+\")\"},setHref=function(t,o,a){t.href=o,t.target=a?\"_blank\":\"_top\"},setStyle=function(t,o){for(var a in o)t.style[a]=o[a]},hasClass=function(t,o){return t.className.match(new RegExp(\"(\\\\s|^)\"+o+\"(\\\\s|$)\"))},addClass=function(t,o){hasClass(t,o)||(t.className+=\" \"+o)},removeClass=function(t,o){if(hasClass(t,o)){var a=new RegExp(\"(\\\\s|^)\"+o+\"(\\\\s|$)\");t.className=t.className.replace(a,\" \")}},show=function(t){removeClass(t,\"hide\")},hide=function(t){addClass(t,\"hide\")},trimText=function(t){return t.replace(/^\\s+|\\s+$/,\"\")},getSimulationValue=function(t,o){try{return parent&&parent.sim&&parent.sim[t]?parent.sim[t]:o}catch(a){return o}},isShazamPreview=function(){try{return parent&&parent.sim}catch(t){return!1}},callService=function(t,o,a,e,i,n,s){var c=\"serviceCallback\",d=0;o.JSONCallBack=c,\"undefined\"!=typeof ClientMetrics&&ClientMetrics.startTimer(ClientMetrics.events.AAN_TIME),window[c]=function(t){(\"undefined\"==typeof t||\"undefined\"==typeof t.error)&&(a=-1,s=window[c]=DO_NOTHING,\"undefined\"!=typeof ClientMetrics&&(ClientMetrics.endTimer(ClientMetrics.events.AAN_TIME),ClientMetrics.logEvent(ClientMetrics.events.NUM_AAN_CALLS,d)),n(t))},function r(){if(a>0){var n=document.createElement(\"script\");n.src=\"//\"+t+\"?\"+getQueryString(o),document.body.appendChild(n),a--,d++,setTimeout(r,e),e*=i}else!a&&s&&(s(),\"undefined\"!=typeof ClientMetrics&&(ClientMetrics.addMetric(ClientMetrics.events.FINAL_STATE,\"aanFail\"),ClientMetrics.addMetric(ClientMetrics.events.NUM_AAN_CALLS,d),ClientMetrics.flushMetrics()))}()},truncateText=function(t,o,a){var e,i=t.innerHTML,n=i;if(o.offsetHeight>a)for(;o.offsetHeight>a;){var s=o.offsetHeight;if(e=i.replace(/\\s+\\S+\\s*$/,\"\"),e.length==i.length)break;i=e,t.innerHTML=i+\"...\",o.offsetHeight<s&&(n=t.innerHTML)}return t.innerHTML=n,o.offsetHeight<=a},expandSlot=function(){},fullLogoPaths={blackOrangeLogo:\"da/creatives/logo_orangeblack._V390083514_.png\",blackLogo:\"da/creatives/logo_black._V390083509_.png\",whiteOrangeLogo:\"da/creatives/logo_orangewhite._V390083509_.png\",whiteLogo:\"da/creatives/logo_white._V390083514_.png\"},smallLogoPaths={blackOrangeLogo:\"da/creatives/small_logo_orangeblack._V368061135_.png\",blackLogo:\"da/creatives/small_logo_black._V368061135_.png\",whiteOrangeLogo:\"da/creatives/small_logo_orangewhite._V368061134_.png\",whiteLogo:\"da/creatives/small_logo_white._V368061135_.png\"},getAapLogoPath=function(t,o){return o?smallLogoPaths[t]:fullLogoPaths[t]},BACKGROUND_CLICK_TRAFFIC_EVENT_TYPE=\"adBackgroundClick\",TITLE_CLICK_TRAFFIC_EVENT_TYPE=\"adTitleClick\",ATC_CLICK_TRAFFIC_EVENT_TYPE=\"addToCartClick\",SHOP_NOW_CLICK_TRAFFIC_EVENT_TYPE=\"shopNowClick\",PREORDER_CLICK_TRAFFIC_EVENT_TYPE=\"preorderClick\",CLIP_COUPON_CLICK_TRAFFIC_EVENT_TYPE=\"clipCouponClick\",MORE_INFO_CLICK_TRAFFIC_EVENT_TYPE=\"moreInfoClick\",READ_ALL_REVIEWS_CLICK_TRAFFIC_EVENT_TYPE=\"readAllReviewsClick\",PRIMARY_CTA_CLICK_TRAFFIC_EVENT_TYPE=\"primaryCtaClick\",ALTCTA_CLICK_TRAFFIC_EVENT_TYPE=\"altCtaClick\",LEARN_MORE_TRAFFIC_EVENT_TYPE=\"learnMore\",ADD_TO_WISHLIST_TRAFFIC_EVENT_TYPE=\"addToWishlistClick\",SNS_CLICK_TRAFFIC_EVENT_TYPE=\"subscribeAndSaveClick\",CLOSE_MODAL_EVENT_TYPE=\"closeModalClick\",VALID_EVENTS=[BACKGROUND_CLICK_TRAFFIC_EVENT_TYPE,TITLE_CLICK_TRAFFIC_EVENT_TYPE,ATC_CLICK_TRAFFIC_EVENT_TYPE,SHOP_NOW_CLICK_TRAFFIC_EVENT_TYPE,PREORDER_CLICK_TRAFFIC_EVENT_TYPE,CLIP_COUPON_CLICK_TRAFFIC_EVENT_TYPE,MORE_INFO_CLICK_TRAFFIC_EVENT_TYPE,READ_ALL_REVIEWS_CLICK_TRAFFIC_EVENT_TYPE,PRIMARY_CTA_CLICK_TRAFFIC_EVENT_TYPE,ALTCTA_CLICK_TRAFFIC_EVENT_TYPE,LEARN_MORE_TRAFFIC_EVENT_TYPE,ADD_TO_WISHLIST_TRAFFIC_EVENT_TYPE,CLOSE_MODAL_EVENT_TYPE,SNS_CLICK_TRAFFIC_EVENT_TYPE],SIS_PROTOCOL=\"ANY\",SIS_BASE_URL=(\"ANY\"===SIS_PROTOCOL?location.protocol:SIS_PROTOCOL)+\"//s.amazon-adsystem.com\",THIRD_PARTY_TRACKER=\"\",adId=\"1848988770301\",creativeId=\"5745144100401\",adServer=\"pda\",impressionId=\'RL7JU199B.JYauA3WlorXA\',isValidEvent=function(t){for(var o=0;o<VALID_EVENTS.length;o++)if(VALID_EVENTS[o]===t)return!0;return!1},getClickTracker=function(t,o,a){\"undefined\"==typeof UrlUtils&&(window.UrlUtils={hasRefTag:function(t){return/[\\/&?]\\s*ref_?=[^&#?\\/:]*/.test(t)},hasAssociateTag:function(t){return/[\\/&?]\\s*tag_?=[^&#?\\/:]*/.test(t)},isAmazonUri:function(t){var o=t.replace(/^[a-zA-Z][a-zA-Z0-9+.-]*:\\/\\//,\"\"),a=o.split(/[\\/?#:]/).filter(function(t){return 0!=t.length});return a[0]?/amazon[.]([a-zA-Z]+$|[a-zA-Z]+.[a-zA-Z]+$)/.test(a[0]):!1},injectQueryStringParam:function(t,o,a){if(!o||!a)return t;var e=\"?\"+o+\"=\"+a,i=t.indexOf(\"#\"),n=t.indexOf(\"?\"),s=i>=0,c=n>=0;if(s&&c&&(c=i>n),!c&&!s)return t+e;var d=c?\"?\":\"#\",r=t.split(d),u=r.slice(1).join(d);c&&(d=\"&\");var m=r[0]+e;return u&&(m+=d+u),m},injectAapRefTag:function(t){var o=\"undefined\"!=typeof IS_3P&&IS_3P,a=\"\",e=\"\";return t&&a&&e&&o&&this.isAmazonUri(t)?this.hasRefTag(t)&&this.hasAssociateTag(t)?t:!this.hasRefTag(t)&&this.hasAssociateTag(t)?this.injectQueryStringParam(t,\"ref\",a):this.hasRefTag(t)&&!this.hasAssociateTag(t)?this.injectQueryStringParam(t,\"tag\",e):this.injectQueryStringParam(this.injectQueryStringParam(t,\"ref\",a),\"tag\",e):t},getCouponToken:function(){return btoa((new Date).getTime()+\";AMG\")},getCouponTokenMacro:function(){return\"VPC_CS_TOKEN_MACRO\"}}),o=UrlUtils.injectAapRefTag(o);var e={i:impressionId,e:t,a:adId,c:creativeId,s:adServer},i={d:\"forester-did\",\"ex-fargs\":encodeURIComponent(\"?\"+getQueryString(e)),\"ex-fch\":416719,rd:o?encodeURIComponent(o):\"\",cb:(new Date).getTime()};o&&a&&(i.sig=a);var n=\"\",s=\"\",c=\"%3F\",d=\"%26\",r=\"%2F\",u=\"%3D\",m=\"ref\"+u+n,C=\"tag\"+u+s;n&&\"\"!==n&&i.rd&&(-1!=i.rd.indexOf(c)?i.rd=i.rd.replace(new RegExp(c),r+m+c+(s?C+d:\"\")):i.rd=i.rd+r+m+(s?c+C:\"\"));var l=SIS_BASE_URL+(o?\"/click\":\"/iui3\")+\"?\"+getQueryString(i);return l},setTrackerHref=function(t,o,a,e,i){setHref(t,getClickTracker(o,a,i),e)},addAsyncTracking=function(t,o,a){DADS.Analytics.track3PClickAsync(t,o,a)},attachAsyncAaxTracker=function(t){},VALID_IMDB_EVENTS=[\"adBackgroundClick\",\"adCustomAction\",\"adCustomAction2\",\"adCustomAction3\",\"adCustomAction4\",\"adCustomAction5\",\"adCustomAction6\",\"adCustomAction7\",\"adCustomAction8\",\"adCustomAction9\",\"adCustomAction10\",\"adCustomAction11\",\"adCustomAction12\",\"adCustomAction13\",\"adCustomAction14\",\"adCustomAction15\",\"adCustomAction16\",\"adCustomAction17\",\"adCustomAction18\",\"adCustomAction19\",\"adCustomAction20\",\"adCustomAction1000\",\"adCustomAction1001\",\"adCustomAction1002\",\"adCustomAction1003\",\"adCustomAction1004\",\"adCustomAction1005\",\"adCustomAction1006\",\"adCustomAction1007\",\"adCustomAction1008\",\"adCustomAction1009\",\"adCustomAction1010\",\"adCustomAction1011\",\"adCustomAction1012\",\"adCustomAction1013\",\"adCustomAction1014\",\"adCustomAction1015\",\"adCustomAction1016\",\"adCustomAction1017\",\"adCustomAction1018\",\"adCustomAction1019\",\"adCustomAction1020\",\"adCustomAction1021\",\"adCustomAction1022\",\"adCustomAction1023\",\"adCustomAction1024\",\"adCustomAction1025\",\"adCustomAction1026\",\"adCustomAction1027\",\"adCustomAction1028\",\"adCustomAction1029\",\"adCustomAction1030\",\"adCustomAction1031\",\"adCustomAction1032\",\"adCustomAction1033\",\"adCustomAction1034\",\"adCustomAction1035\",\"adCustomAction1036\",\"adCustomAction1037\",\"adCustomAction1038\",\"adCustomAction1039\",\"adCustomAction1040\",\"adCustomAction1041\",\"adCustomAction1042\",\"adCustomAction1043\",\"adCustomAction1044\",\"adCustomAction1045\",\"adCustomAction1046\",\"adCustomAction1047\",\"adCustomAction1048\",\"adCustomAction1049\",\"adCustomAction1050\",\"adCustomAction1051\",\"adCustomAction1052\",\"adCustomAction1053\",\"adCustomAction1054\",\"adCustomAction1055\",\"adCustomAction1056\",\"adCustomAction1057\",\"adCustomAction1058\",\"adCustomAction1059\",\"adCustomAction1060\",\"adCustomAction1061\",\"adCustomAction1062\",\"adCustomAction1063\",\"adCustomAction1064\",\"adCustomAction1065\",\"adCustomAction1066\",\"adCustomAction1067\",\"adCustomAction1068\",\"adCustomAction1069\",\"adCustomAction1070\",\"adCustomAction1071\",\"adCustomAction1072\",\"adCustomAction1073\",\"adCustomAction1074\",\"adCustomAction1075\",\"adCustomAction1076\",\"adCustomAction1077\",\"adCustomAction1078\",\"adCustomAction1079\",\"adCustomAction1080\",\"adCustomAction1081\",\"adCustomAction1082\",\"adCustomAction1083\",\"adCustomAction1084\",\"adCustomAction1085\",\"adCustomAction1086\",\"adCustomAction1087\",\"adCustomAction1088\",\"adCustomAction1089\",\"adCustomAction1090\",\"adCustomAction1091\",\"adCustomAction1092\",\"adCustomAction1093\",\"adCustomAction1094\",\"adCustomAction1095\",\"adCustomAction1096\",\"adCustomAction1097\",\"adCustomAction1098\",\"adCustomAction1099\",\"adCustomAction1100\",\"adCustomAction1101\",\"adCustomAction1102\",\"adCustomAction1103\",\"adCustomAction1104\",\"adCustomAction1105\",\"adCustomAction1106\",\"adCustomAction1107\",\"adCustomAction1108\",\"adCustomAction1109\",\"adCustomAction1110\",\"adCustomAction1111\",\"adCustomAction1112\",\"adCustomAction1113\",\"adCustomAction1114\",\"adCustomAction1115\",\"adCustomAction1116\",\"adCustomAction1117\",\"adCustomAction1118\",\"adCustomAction1119\",\"adCustomAction1120\",\"adCustomAction1121\",\"adCustomAction1122\",\"adCustomAction1123\",\"adCustomAction1124\",\"adCustomAction1125\",\"adCustomAction1126\",\"adCustomAction1127\",\"adCustomAction1128\",\"adCustomAction1129\",\"adCustomAction1130\",\"adCustomAction1131\",\"adCustomAction1132\",\"adCustomAction1133\",\"adCustomAction1134\",\"adCustomAction1135\",\"adCustomAction1136\",\"adCustomAction1137\",\"adCustomAction1138\",\"adCustomAction1139\",\"adCustomAction1140\",\"adCustomAction1141\",\"adCustomAction1142\",\"adCustomAction1143\",\"adCustomAction1144\",\"adCustomAction1145\",\"adCustomAction1146\",\"adCustomAction1147\",\"adCustomAction1148\",\"adCustomAction1149\",\"adCustomAction1150\",\"adCustomAction1151\",\"adCustomAction1152\",\"adCustomAction1153\",\"adCustomAction1154\",\"adCustomAction1155\",\"adCustomAction1156\",\"adCustomAction1157\",\"adCustomAction1158\",\"adCustomAction1159\",\"adCustomAction1160\",\"adCustomAction1161\",\"adCustomAction1162\",\"adCustomAction1163\",\"adCustomAction1164\",\"adCustomAction1165\",\"adCustomAction1166\",\"adCustomAction1167\",\"adCustomAction1168\",\"adCustomAction1169\",\"adCustomAction1170\",\"adCustomAction1171\",\"adCustomAction1172\",\"adCustomAction1173\",\"adCustomAction1174\",\"adCustomAction1175\",\"adCustomAction1176\",\"adCustomAction1177\",\"adCustomAction1178\",\"adCustomAction1179\",\"adCustomAction1180\",\"adCustomAction1181\",\"adCustomAction1182\",\"adCustomAction1183\",\"adCustomAction1184\",\"adCustomAction1185\",\"adCustomAction1186\",\"adCustomAction1187\",\"adCustomAction1188\",\"adCustomAction1189\",\"adCustomAction1190\",\"adCustomAction1191\",\"adCustomAction1192\",\"adCustomAction1193\",\"adCustomAction1194\",\"adCustomAction1195\",\"adCustomAction1196\",\"adCustomAction1197\",\"adCustomAction1198\",\"adCustomAction1199\",\"adCustomAction1200\",\"adCustomAction1201\",\"adCustomAction1202\",\"adCustomAction1203\",\"adCustomAction1204\",\"adCustomAction1205\",\"adCustomAction1206\",\"adCustomAction1207\",\"adCustomAction1208\",\"adCustomAction1209\",\"adCustomAction1210\",\"adCustomAction1211\",\"adCustomAction1212\",\"adCustomAction1213\",\"adCustomAction1214\",\"adCustomAction1215\",\"adCustomAction1216\",\"adCustomAction1217\",\"adCustomAction1218\",\"adCustomAction1219\",\"adCustomAction1220\",\"adCustomAction1221\",\"adCustomAction1222\",\"adCustomAction1223\",\"adCustomAction1224\",\"adCustomAction1225\",\"adCustomAction1226\",\"adCustomAction1227\",\"adCustomAction1228\",\"adCustomAction1229\",\"adCustomAction1230\",\"adCustomAction1231\",\"adCustomAction1232\",\"adCustomAction1233\",\"adCustomAction1234\",\"adCustomAction1235\",\"adCustomAction1236\",\"adCustomAction1237\",\"adCustomAction1238\",\"adCustomAction1239\",\"adCustomAction1240\",\"adCustomAction1241\",\"adCustomAction1242\",\"adCustomAction1243\",\"adCustomAction1244\",\"adCustomAction1245\",\"adCustomAction1246\",\"adCustomAction1247\",\"adCustomAction1248\",\"adCustomAction1249\",\"adCustomAction1250\",\"adCustomAction1251\",\"adCustomAction1252\",\"adCustomAction1253\",\"adCustomAction1254\",\"adCustomAction1255\",\"adCustomAction1256\",\"adCustomAction1257\",\"adCustomAction1258\",\"adCustomAction1259\",\"adCustomAction1260\",\"adCustomAction1261\",\"adCustomAction1262\",\"adCustomAction1263\",\"adCustomAction1264\",\"adCustomAction1265\",\"adCustomAction1266\",\"adCustomAction1267\",\"adCustomAction1268\",\"adCustomAction1269\",\"adCustomAction1270\",\"adCustomAction1271\",\"adCustomAction1272\",\"adCustomAction1273\",\"adCustomAction1274\",\"adCustomAction1275\",\"adCustomAction1276\",\"adCustomAction1277\",\"adCustomAction1278\",\"adCustomAction1279\",\"adCustomAction1280\",\"adCustomAction1281\",\"adCustomAction1282\",\"adCustomAction1283\",\"adCustomAction1284\",\"adCustomAction1285\",\"adCustomAction1286\",\"adCustomAction1287\",\"adCustomAction1288\",\"adCustomAction1289\",\"adCustomAction1290\",\"adCustomAction1291\",\"adCustomAction1292\",\"adCustomAction1293\",\"adCustomAction1294\",\"adCustomAction1295\",\"adCustomAction1296\",\"adCustomAction1297\",\"adCustomAction1298\",\"adCustomAction1299\",\"adCustomAction1300\",\"adCustomAction1301\",\"adCustomAction1302\",\"adCustomAction1303\",\"adCustomAction1304\",\"adCustomAction1305\",\"adCustomAction1306\",\"adCustomAction1307\",\"adCustomAction1308\",\"adCustomAction1309\",\"adCustomAction1310\",\"adCustomAction1311\",\"adCustomAction1312\",\"adCustomAction1313\",\"adCustomAction1314\",\"adCustomAction1315\",\"adCustomAction1316\",\"adCustomAction1317\",\"adCustomAction1318\",\"adCustomAction1319\",\"adCustomAction1320\",\"adCustomAction1321\",\"adCustomAction1322\",\"adCustomAction1323\",\"adCustomAction1324\",\"adCustomAction1325\",\"adCustomAction1326\",\"adCustomAction1327\",\"adCustomAction1328\",\"adCustomAction1329\",\"adCustomAction1330\",\"adCustomAction1331\",\"adCustomAction1332\",\"adCustomAction1333\",\"adCustomAction1334\",\"adCustomAction1335\",\"adCustomAction1336\",\"adCustomAction1337\",\"adCustomAction1338\",\"adCustomAction1339\",\"adCustomAction1340\",\"adCustomAction1341\",\"adCustomAction1342\",\"adCustomAction1343\",\"adCustomAction1344\",\"adCustomAction1345\",\"adCustomAction1346\",\"adCustomAction1347\",\"adCustomAction1348\",\"adCustomAction1349\",\"adCustomAction1350\",\"adCustomAction1351\",\"adCustomAction1352\",\"adCustomAction1353\",\"adCustomAction1354\",\"adCustomAction1355\",\"adCustomAction1356\",\"adCustomAction1357\",\"adCustomAction1358\",\"adCustomAction1359\",\"adCustomAction1360\",\"adCustomAction1361\",\"adCustomAction1362\",\"adCustomAction1363\",\"adCustomAction1364\",\"adCustomAction1365\",\"adCustomAction1366\",\"adCustomAction1367\",\"adCustomAction1368\",\"adCustomAction1369\",\"adCustomAction1370\",\"adCustomAction1371\",\"adCustomAction1372\",\"adCustomAction1373\",\"adCustomAction1374\",\"adCustomAction1375\",\"adCustomAction1376\",\"adCustomAction1377\",\"adCustomAction1378\",\"adCustomAction1379\",\"adCustomAction1380\",\"adCustomAction1381\",\"adCustomAction1382\",\"adCustomAction1383\",\"adCustomAction1384\",\"adCustomAction1385\",\"adCustomAction1386\",\"adCustomAction1387\",\"adCustomAction1388\",\"adCustomAction1389\",\"adCustomAction1390\",\"adCustomAction1391\",\"adCustomAction1392\",\"adCustomAction1393\",\"adCustomAction1394\",\"adCustomAction1395\",\"adCustomAction1396\",\"adCustomAction1397\",\"adCustomAction1398\",\"adCustomAction1399\",\"adCustomAction1400\",\"adCustomAction1401\",\"adCustomAction1402\",\"adCustomAction1403\",\"adCustomAction1404\",\"adCustomAction1405\",\"adCustomAction1406\",\"adCustomAction1407\",\"adCustomAction1408\",\"adCustomAction1409\",\"adCustomAction1410\",\"adCustomAction1411\",\"adCustomAction1412\",\"adCustomAction1413\",\"adCustomAction1414\",\"adCustomAction1415\",\"adCustomAction1416\",\"adCustomAction1417\",\"adCustomAction1418\",\"adCustomAction1419\",\"adCustomAction1420\",\"adCustomAction1421\",\"adCustomAction1422\",\"adCustomAction1423\",\"adCustomAction1424\",\"adCustomAction1425\",\"adCustomAction1426\",\"adCustomAction1427\",\"adCustomAction1428\",\"adCustomAction1429\",\"adCustomAction1430\",\"adCustomAction1431\",\"adCustomAction1432\",\"adCustomAction1433\",\"adCustomAction1434\",\"adCustomAction1435\",\"adCustomAction1436\",\"adCustomAction1437\",\"adCustomAction1438\",\"adCustomAction1439\",\"adCustomAction1440\",\"adCustomAction1441\",\"adCustomAction1442\",\"adCustomAction1443\",\"adCustomAction1444\",\"adCustomAction1445\",\"adCustomAction1446\",\"adCustomAction1447\",\"adCustomAction1448\",\"adCustomAction1449\",\"adCustomAction1450\",\"adCustomAction1451\",\"adCustomAction1452\",\"adCustomAction1453\",\"adCustomAction1454\",\"adCustomAction1455\",\"adCustomAction1456\",\"adCustomAction1457\",\"adCustomAction1458\",\"adCustomAction1459\",\"adCustomAction1460\",\"adCustomAction1461\",\"adCustomAction1462\",\"adCustomAction1463\",\"adCustomAction1464\",\"adCustomAction1465\",\"adCustomAction1466\",\"adCustomAction1467\",\"adCustomAction1468\",\"adCustomAction1469\",\"adCustomAction1470\",\"adCustomAction1471\",\"adCustomAction1472\",\"adCustomAction1473\",\"adCustomAction1474\",\"adCustomAction1475\",\"adCustomAction1476\",\"adCustomAction1477\",\"adCustomAction1478\",\"adCustomAction1479\",\"adCustomAction1480\",\"adCustomAction1481\",\"adCustomAction1482\",\"adCustomAction1483\",\"adCustomAction1484\",\"adCustomAction1485\",\"adCustomAction1486\",\"adCustomAction1487\",\"adCustomAction1488\",\"adCustomAction1489\",\"adCustomAction1490\",\"adCustomAction1491\",\"adCustomAction1492\",\"adCustomAction1493\",\"adCustomAction1494\",\"adCustomAction1495\",\"adCustomAction1496\",\"adCustomAction1497\",\"adCustomAction1498\",\"adCustomAction1499\",\"addToCartClick\",\"addToWishlistClick\",\"adTitleClick\",\"click\",\"clipCouponClick\",\"compare\",\"filterByApplication\",\"filterByFeatures\",\"filterByPrice\",\"galleryClick\",\"galleryClick2\",\"galleryClick3\",\"galleryClick4\",\"galleryClick5\",\"galleryClick6\",\"galleryClick7\",\"galleryClick8\",\"galleryClick9\",\"galleryClick10\",\"galleryClick11\",\"galleryClick12\",\"galleryClick13\",\"galleryClick14\",\"galleryClick15\",\"galleryShopnow\",\"galleryShopnow2\",\"galleryShopnow3\",\"galleryShopnow4\",\"galleryShopnow5\",\"galleryShopnow6\",\"galleryShopnow7\",\"galleryShopnow8\",\"galleryShopnow9\",\"galleryShopnow10\",\"galleryShopnow11\",\"galleryShopnow12\",\"galleryShopnow13\",\"galleryShopnow14\",\"galleryShopnow15\",\"gallerySwipes\",\"learnMore\",\"masterClick\",\"masterImpression\",\"mshopPopoverClick\",\"preorderClick\",\"shopNowClick\",\"socialInteractions\",\"subscribeAndSaveClick\",\"tabClick\",\"tabClick2\",\"tabClick3\",\"tabClick4\",\"tabClick5\",\"tabClick6\",\"tabClick7\",\"tabClick8\",\"tabClick9\",\"tabClick10\",\"videoClick\",\"videoClick2\",\"videoClick3\",\"videoClick4\",\"videoClick5\",\"videoComplete\",\"videoComplete2\",\"videoComplete3\",\"videoComplete4\",\"videoComplete5\",\"videoCreativeView\",\"videoCreativeView2\",\"videoCreativeView3\",\"videoCreativeView4\",\"videoCreativeView5\",\"videoFirstQuartile\",\"videoFirstQuartile2\",\"videoFirstQuartile3\",\"videoFirstQuartile4\",\"videoFirstQuartile5\",\"videoImpression\",\"videoImpression2\",\"videoImpression3\",\"videoImpression4\",\"videoImpression5\",\"videoMidpoint\",\"videoMidpoint2\",\"videoMidpoint3\",\"videoMidpoint4\",\"videoMidpoint5\",\"videoMute\",\"videoMute2\",\"videoMute3\",\"videoMute4\",\"videoMute5\",\"videoPause\",\"videoPause2\",\"videoPause3\",\"videoPause4\",\"videoPause5\",\"videoReplay\",\"videoReplay2\",\"videoReplay3\",\"videoReplay4\",\"videoReplay5\",\"videoResume\",\"videoResume2\",\"videoResume3\",\"videoResume4\",\"videoResume5\",\"videoSkipBackward\",\"videoSkipBackward2\",\"videoSkipBackward3\",\"videoSkipBackward4\",\"videoSkipBackward5\",\"videoSkipForward\",\"videoSkipForward2\",\"videoSkipForward3\",\"videoSkipForward4\",\"videoSkipForward5\",\"videoStart\",\"videoStart2\",\"videoStart3\",\"videoStart4\",\"videoStart5\",\"videoThirdQuartile\",\"videoThirdQuartile2\",\"videoThirdQuartile3\",\"videoThirdQuartile4\",\"videoThirdQuartile5\",\"videoUnmute\",\"videoUnmute2\",\"videoUnmute3\",\"videoUnmute4\",\"videoUnmute5\"];VALID_EVENTS=VALID_EVENTS.concat(VALID_IMDB_EVENTS);var originalGetClickTracker=getClickTracker,getClickTracker=function(t,o){var a=document.createElement(\"a\");return a.href=originalGetClickTracker(t,o),a.protocol=\"https\",a.href},adData=JSON.parse(\'{\"id\":\"billboard\",\"name\":\"billboard\",\"frameProperties\":{\"width\":1920,\"height\":1500,\"offsetX\":-475,\"offsetY\":-68,\"position\":\"relative\"},\"trackingConfigs\":[{\"componentName\":\"min-primary-cta\",\"trackingType\":\"tab\",\"data\":{\"trackingLabel\":\"Click Primary CTA (Top)\",\"trackingNumber\":1}},{\"componentName\":\"ue-primary-cta\",\"trackingType\":\"tab\",\"data\":{\"trackingLabel\":\"Click Primary CTA (Top)\",\"trackingNumber\":1}},{\"componentName\":\"ue-title\",\"trackingType\":\"custom\",\"data\":{\"trackingLabel\":\"Click Title\",\"trackingNumber\":1402}},{\"componentName\":\"min-expand\",\"trackingType\":\"tab\",\"data\":{\"trackingLabel\":\"Click Expand\",\"trackingNumber\":9}},{\"componentName\":\"ue-collapse\",\"trackingType\":\"tab\",\"data\":{\"trackingLabel\":\"Click Collapse\",\"trackingNumber\":10}},{\"componentName\":\"intro-collapse\",\"trackingType\":\"tab\",\"data\":{\"trackingLabel\":\"Click Collapse\",\"trackingNumber\":10}},{\"componentName\":\"autoplay-trailer-panel\",\"trackingType\":\"custom\",\"data\":{\"trackingLabel\":\"Click Replay With Sound\",\"trackingNumber\":1400}},{\"componentName\":\"trailer-resolve-panel\",\"trackingType\":\"custom\",\"data\":{\"trackingLabel\":\"Click Replay With Sound\",\"trackingNumber\":1400}},{\"componentName\":\"intro-skip\",\"trackingType\":\"custom\",\"data\":{\"trackingLabel\":\"Click Skip Intro\",\"trackingNumber\":1401}},{\"componentName\":\"autoplay-trailer\",\"trackingType\":\"video\",\"data\":{\"trackingLabel\":\"All Trailers\",\"trackingNumber\":1}},{\"componentName\":\"trailer-video\",\"trackingType\":\"video\",\"data\":{\"trackingLabel\":\"All Trailers\",\"trackingNumber\":1}},{\"componentName\":\"intro-video\",\"trackingType\":\"video\",\"data\":{\"trackingLabel\":\"Intro Video\",\"trackingNumber\":2}},{\"componentName\":\"autoplay-trailer\",\"trackingType\":\"video\",\"data\":{\"trackingLabel\":\"Autoplay Trailer\",\"trackingNumber\":3}},{\"componentName\":\"trailer-video\",\"trackingType\":\"video\",\"data\":{\"trackingLabel\":\"User-initiated Trailer\",\"trackingNumber\":4}}],\"assets\":{\"ue-wrap\":{\"url\":\"https://m.media-amazon.com/images/I/81QcoNtf8BL.jpg\"},\"min-messaging\":{\"url\":\"https://m.media-amazon.com/images/I/71hanwKYNPL.png\"},\"min-tunein\":{\"url\":\"https://m.media-amazon.com/images/I/21bb5hKWhjL.png\"},\"min-title\":{\"url\":\"https://m.media-amazon.com/images/I/51F8Mn2A9nL.png\"},\"min-primary-cta\":{\"url\":\"https://m.media-amazon.com/images/I/11bJfseMooL.png\"},\"min-primary-cta-hover\":{\"url\":\"https://m.media-amazon.com/images/I/11gL5E24UlL.png\"},\"min-expand\":{\"url\":\"https://m.media-amazon.com/images/I/11vVlh0GjLL.png\"},\"min-expand-hover\":{\"url\":\"https://m.media-amazon.com/images/I/118SMhVjsML.png\"},\"intro-video\":{\"type\":\"video\",\"url\":\"https://m.media-amazon.com/images/I/A1BwQw6DRlL.mp4\"},\"intro-skip\":{\"url\":\"https://m.media-amazon.com/images/I/01hhCc82l6L.png\"},\"intro-skip-hover\":{\"url\":\"https://m.media-amazon.com/images/I/01Q-DW12K+L.png\"},\"ue-collapse\":{\"url\":\"https://m.media-amazon.com/images/I/1167osHKxSL.png\"},\"ue-collapse-hover\":{\"url\":\"https://m.media-amazon.com/images/I/11bUdpiTKcL.png\"},\"trailer-video\":{\"type\":\"video\",\"url\":\"https://m.media-amazon.com/images/I/E1wWRtSsvtS.mp4\"},\"replay\":{\"url\":\"https://m.media-amazon.com/images/I/31-dg8RzwdL.png\"},\"trailer-video-slate\":{\"url\":\"https://m.media-amazon.com/images/I/41dx0704XLL.jpg\"},\"trailer-overlay\":{\"url\":\"https://m.media-amazon.com/images/I/510YQqUMppL.png\"},\"ue-messaging\":{\"url\":\"https://m.media-amazon.com/images/I/81G1B5eK8mL.png\"},\"ue-tunein\":{\"url\":\"https://m.media-amazon.com/images/I/01vtPGIEGjL.png\"},\"ue-title\":{\"url\":\"https://m.media-amazon.com/images/I/51eqCzbszsL.png\"},\"ue-title-hover\":{\"url\":\"https://m.media-amazon.com/images/I/51J3BgMJ5JL.png\"},\"ue-primary-cta\":{\"url\":\"https://m.media-amazon.com/images/I/11C3xDiE82L.png\"},\"ue-primary-cta-hover\":{\"url\":\"https://m.media-amazon.com/images/I/21AqVxaayvL.png\"}},\"actions\":{\"init\":[{\"actionName\":\"call-external-function\",\"data\":{\"functionName\":\"CustomScript.init\",\"context\":\"top\"},\"delay\":10}]},\"children\":[{\"type\":\"graphic\",\"name\":\"wrap\",\"rect\":{\"offsetX\":0,\"offsetY\":0,\"width\":1920,\"height\":1522},\"asset\":\"ue-wrap\",\"isHidden\":true,\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.4s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"}]},{\"type\":\"rotator\",\"name\":\"main-rotator\",\"rect\":{\"offsetX\":0,\"offsetY\":0,\"width\":1920,\"height\":1500},\"activeIndex\":0,\"children\":[{\"type\":\"panel\",\"name\":\"empty-panel\",\"rect\":{\"offsetX\":0,\"offsetY\":0,\"width\":1,\"height\":1}},{\"type\":\"panel\",\"name\":\"min-panel\",\"rect\":{\"offsetX\":0,\"offsetY\":0,\"width\":1920,\"height\":220},\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.4s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"}],\"transitionsOut\":[{\"type\":\"opacity\",\"duration\":\"0.2s\",\"startValue\":1,\"endValue\":0,\"delay\":\"0s\",\"easing\":\"cubic-bezier(0.215, 0.610, 0.355, 1.000)\"}],\"actions\":{\"init\":[{\"actionName\":\"show-component\",\"componentName\":\"wrap\"}]},\"children\":[{\"type\":\"graphic\",\"name\":\"min-messaging\",\"rect\":{\"offsetX\":902,\"offsetY\":57,\"width\":527,\"height\":311},\"asset\":\"min-messaging\",\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.3s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0.3s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"},{\"type\":\"translateY\",\"duration\":\"0.8s\",\"startValue\":\"20px\",\"endValue\":\"0px\",\"delay\":\"0.3s\",\"easing\":\"cubic-bezier(0.215, 0.610, 0.355, 1.000)\"}]},{\"type\":\"graphic\",\"name\":\"min-tunein\",\"rect\":{\"offsetX\":516,\"offsetY\":72,\"width\":404,\"height\":233},\"asset\":\"min-tunein\",\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.3s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0.4s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"},{\"type\":\"translateY\",\"duration\":\"0.8s\",\"startValue\":\"20px\",\"endValue\":\"0px\",\"delay\":\"0.4s\",\"easing\":\"cubic-bezier(0.215, 0.610, 0.355, 1.000)\"}]},{\"type\":\"graphic\",\"name\":\"min-title\",\"rect\":{\"offsetX\":514,\"offsetY\":107,\"width\":397,\"height\":131},\"asset\":\"min-title\",\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.3s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0.2s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"},{\"type\":\"translateY\",\"duration\":\"0.8s\",\"startValue\":\"20px\",\"endValue\":\"0px\",\"delay\":\"0.2s\",\"easing\":\"cubic-bezier(0.215, 0.610, 0.355, 1.000)\"}]},{\"type\":\"graphic\",\"name\":\"min-primary-cta\",\"rect\":{\"offsetX\":641,\"offsetY\":240,\"width\":154,\"height\":42},\"asset\":\"min-primary-cta\",\"hoverAsset\":\"min-primary-cta-hover\",\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.3s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0.5s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"},{\"type\":\"translateY\",\"duration\":\"0.8s\",\"startValue\":\"20px\",\"endValue\":\"0px\",\"delay\":\"0.5s\",\"easing\":\"cubic-bezier(0.215, 0.610, 0.355, 1.000)\"}],\"actions\":{\"click\":[{\"actionName\":\"open-default-link\"}]}},{\"type\":\"graphic\",\"name\":\"min-expand\",\"rect\":{\"offsetX\":1333,\"offsetY\":69,\"width\":102,\"height\":26},\"asset\":\"min-expand\",\"hoverAsset\":\"min-expand-hover\",\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.3s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0.2s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"},{\"type\":\"translateY\",\"duration\":\"0.5s\",\"startValue\":\"-15px\",\"endValue\":\"0px\",\"delay\":\"0.2s\",\"easing\":\"cubic-bezier(0.215, 0.610, 0.355, 1.000)\"}],\"actions\":{\"click\":[{\"actionName\":\"call-external-function\",\"data\":{\"functionName\":\"CustomScript.setExpanded\",\"context\":\"top\"}},{\"actionName\":\"route\",\"data\":{\"rotatorConfigs\":[{\"name\":\"main-rotator\",\"index\":3},{\"name\":\"trailer-rotator\",\"index\":1}]}}]}}]},{\"type\":\"panel\",\"name\":\"intro-panel\",\"rect\":{\"offsetX\":0,\"offsetY\":0,\"width\":1920,\"height\":1500},\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.4s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"}],\"transitionsOut\":[{\"type\":\"opacity\",\"duration\":\"0.2s\",\"startValue\":1,\"endValue\":0,\"delay\":\"0s\",\"easing\":\"cubic-bezier(0.215, 0.610, 0.355, 1.000)\"}],\"children\":[{\"type\":\"minimal-video\",\"name\":\"intro-video\",\"rect\":{\"offsetX\":0,\"offsetY\":0,\"width\":1920,\"height\":1000},\"video\":{\"asset\":\"intro-video\",\"loop\":false,\"autoplay\":true,\"autosound\":false},\"actions\":{\"videoComplete\":[{\"actionName\":\"hide-component\",\"componentName\":\"intro-collapse\"},{\"actionName\":\"route\",\"data\":{\"rotatorConfigs\":[{\"name\":\"main-rotator\",\"index\":3}]}}]}},{\"type\":\"graphic\",\"name\":\"intro-skip\",\"rect\":{\"offsetX\":898,\"offsetY\":557,\"width\":124,\"height\":32},\"asset\":\"intro-skip\",\"hoverAsset\":\"intro-skip-hover\",\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.3s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0.2s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"},{\"type\":\"translateY\",\"duration\":\"0.8s\",\"startValue\":\"20px\",\"endValue\":\"0px\",\"delay\":\"0.2s\",\"easing\":\"cubic-bezier(0.215, 0.610, 0.355, 1.000)\"}],\"actions\":{\"click\":[{\"actionName\":\"hide-component\",\"componentName\":\"intro-collapse\"},{\"actionName\":\"route\",\"data\":{\"rotatorConfigs\":[{\"name\":\"main-rotator\",\"index\":3}]}}]}},{\"type\":\"graphic\",\"name\":\"intro-collapse\",\"rect\":{\"offsetX\":1333,\"offsetY\":69,\"width\":102,\"height\":26},\"asset\":\"ue-collapse\",\"hoverAsset\":\"ue-collapse-hover\",\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.3s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0.2s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"},{\"type\":\"translateY\",\"duration\":\"0.5s\",\"startValue\":\"15px\",\"endValue\":\"0px\",\"delay\":\"0.2s\",\"easing\":\"cubic-bezier(0.215, 0.610, 0.355, 1.000)\"}],\"actions\":{\"click\":[{\"actionName\":\"call-external-function\",\"data\":{\"functionName\":\"CustomScript.setCollapsed\",\"context\":\"top\"}},{\"actionName\":\"route\",\"data\":{\"rotatorConfigs\":[{\"name\":\"main-rotator\",\"index\":1}]}}]}}]},{\"type\":\"panel\",\"name\":\"ue-panel\",\"rect\":{\"offsetX\":0,\"offsetY\":0,\"width\":1920,\"height\":1500},\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.4s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"}],\"transitionsOut\":[{\"type\":\"opacity\",\"duration\":\"0.2s\",\"startValue\":1,\"endValue\":0,\"delay\":\"0s\",\"easing\":\"cubic-bezier(0.215, 0.610, 0.355, 1.000)\"}],\"actions\":{\"init\":[{\"actionName\":\"show-component\",\"componentName\":\"wrap\"}]},\"children\":[{\"type\":\"rotator\",\"name\":\"trailer-rotator\",\"rect\":{\"offsetX\":0,\"offsetY\":0,\"width\":1920,\"height\":1500},\"activeIndex\":0,\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.4s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"}],\"children\":[{\"type\":\"panel\",\"name\":\"autoplay-trailer-panel\",\"rect\":{\"offsetX\":529,\"offsetY\":142,\"width\":428,\"height\":240},\"actions\":{\"click\":[{\"actionName\":\"route\",\"data\":{\"rotatorConfigs\":[{\"name\":\"trailer-rotator\",\"index\":1}]}}]},\"children\":[{\"type\":\"minimal-video\",\"name\":\"autoplay-trailer\",\"rect\":{\"offsetX\":0,\"offsetY\":0,\"width\":428,\"height\":240},\"video\":{\"asset\":\"trailer-video\",\"loop\":false,\"autoplay\":true,\"autosound\":true},\"css\":{\"overflow\":\"hidden\"},\"actions\":{\"videoComplete\":[{\"actionName\":\"route\",\"data\":{\"rotatorConfigs\":[{\"name\":\"trailer-rotator\",\"index\":2}]}}]}},{\"type\":\"graphic\",\"name\":\"replay\",\"rect\":{\"offsetX\":150,\"offsetY\":56,\"width\":128,\"height\":128},\"asset\":\"replay\",\"hoverAsset\":\"replay\",\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.4s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0.4s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"},{\"type\":\"translateY\",\"duration\":\"0.8s\",\"startValue\":\"15px\",\"endValue\":\"0px\",\"delay\":\"0.4s\",\"easing\":\"cubic-bezier(0.215, 0.610, 0.355, 1.000)\"}]}]},{\"type\":\"reely\",\"name\":\"trailer-video\",\"rect\":{\"offsetX\":529,\"offsetY\":142,\"width\":428,\"height\":240},\"video\":{\"asset\":\"trailer-video\",\"autoplay\":true,\"autosound\":true},\"controls\":{\"hideBG\":false,\"autohide\":true,\"anchorX\":\"center\",\"anchorY\":\"bottom\",\"offsetX\":\"0%\",\"offsetY\":\"3%\",\"width\":\"75%\"},\"spritesheets\":{\"png\":\"https://m.media-amazon.com/images/G/01/IMDb/design/a/assets/reely-sprites.svg\"},\"actions\":{\"videoComplete\":[{\"actionName\":\"route\",\"data\":{\"rotatorConfigs\":[{\"name\":\"trailer-rotator\",\"index\":2}]}}]}},{\"type\":\"panel\",\"name\":\"trailer-resolve-panel\",\"rect\":{\"offsetX\":529,\"offsetY\":142,\"width\":428,\"height\":240},\"actions\":{\"click\":[{\"actionName\":\"route\",\"data\":{\"rotatorConfigs\":[{\"name\":\"trailer-rotator\",\"index\":1}]}}]},\"children\":[{\"type\":\"graphic\",\"name\":\"trailer-video-slate\",\"rect\":{\"offsetX\":0,\"offsetY\":0,\"width\":428,\"height\":240},\"asset\":\"trailer-video-slate\"},{\"type\":\"graphic\",\"name\":\"replay-resolve\",\"rect\":{\"offsetX\":150,\"offsetY\":56,\"width\":128,\"height\":128},\"asset\":\"replay\",\"hoverAsset\":\"replay\"}]}]},{\"type\":\"graphic\",\"name\":\"trailer-overlay\",\"rect\":{\"offsetX\":506,\"offsetY\":70,\"width\":469,\"height\":334},\"asset\":\"trailer-overlay\",\"css\":{\"pointer-events\":\"none\"},\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.4s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"}]},{\"type\":\"graphic\",\"name\":\"ue-messaging\",\"rect\":{\"offsetX\":920,\"offsetY\":122,\"width\":540,\"height\":548},\"asset\":\"ue-messaging\",\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.3s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0.3s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"},{\"type\":\"translateY\",\"duration\":\"0.8s\",\"startValue\":\"20px\",\"endValue\":\"0px\",\"delay\":\"0.3s\",\"easing\":\"cubic-bezier(0.215, 0.610, 0.355, 1.000)\"}]},{\"type\":\"graphic\",\"name\":\"ue-tunein\",\"rect\":{\"offsetX\":619,\"offsetY\":616,\"width\":215,\"height\":27},\"asset\":\"ue-tunein\",\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.3s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0.4s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"},{\"type\":\"translateY\",\"duration\":\"0.8s\",\"startValue\":\"20px\",\"endValue\":\"0px\",\"delay\":\"0.4s\",\"easing\":\"cubic-bezier(0.215, 0.610, 0.355, 1.000)\"}]},{\"type\":\"graphic\",\"name\":\"ue-title\",\"rect\":{\"offsetX\":467,\"offsetY\":392,\"width\":534,\"height\":208},\"asset\":\"ue-title\",\"hoverAsset\":\"ue-title-hover\",\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.3s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0.2s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"},{\"type\":\"translateY\",\"duration\":\"0.8s\",\"startValue\":\"20px\",\"endValue\":\"0px\",\"delay\":\"0.2s\",\"easing\":\"cubic-bezier(0.215, 0.610, 0.355, 1.000)\"}],\"actions\":{\"click\":[{\"actionName\":\"open-link\",\"data\":{\"url\":\"https://www.imdb.com/title/tt7203552/\",\"sameWindow\":true}}]}},{\"type\":\"graphic\",\"name\":\"ue-primary-cta\",\"rect\":{\"offsetX\":640,\"offsetY\":567,\"width\":179,\"height\":60},\"asset\":\"ue-primary-cta\",\"hoverAsset\":\"ue-primary-cta-hover\",\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.3s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0.5s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"},{\"type\":\"translateY\",\"duration\":\"0.8s\",\"startValue\":\"20px\",\"endValue\":\"0px\",\"delay\":\"0.5s\",\"easing\":\"cubic-bezier(0.215, 0.610, 0.355, 1.000)\"}],\"actions\":{\"click\":[{\"actionName\":\"open-default-link\"}]}},{\"type\":\"graphic\",\"name\":\"ue-collapse\",\"rect\":{\"offsetX\":1333,\"offsetY\":69,\"width\":102,\"height\":26},\"asset\":\"ue-collapse\",\"hoverAsset\":\"ue-collapse-hover\",\"transitionsIn\":[{\"type\":\"opacity\",\"duration\":\"0.3s\",\"startValue\":0,\"endValue\":1,\"delay\":\"0.2s\",\"easing\":\"cubic-bezier(0.550, 0.055, 0.675, 0.190)\"},{\"type\":\"translateY\",\"duration\":\"0.5s\",\"startValue\":\"15px\",\"endValue\":\"0px\",\"delay\":\"0.2s\",\"easing\":\"cubic-bezier(0.215, 0.610, 0.355, 1.000)\"}],\"actions\":{\"click\":[{\"actionName\":\"call-external-function\",\"data\":{\"functionName\":\"CustomScript.setCollapsed\",\"context\":\"top\"}},{\"actionName\":\"route\",\"data\":{\"rotatorConfigs\":[{\"name\":\"main-rotator\",\"index\":1}]}}]}}]}]}]}\');\nadData.defaultLink=\"https://aax-us-east.amazon-adsystem.com/x/c/QkS-yVNffQfyWGrgN1paK1wAAAF8EGnKcAEAAADKAa1-aKg/https://bs.serving-sys.com/Serving/adServer.bs?cn=trd&pli=1077057105&gdpr=&gdpr_consent=&adid=1084725978&ord=945,796,752,269,495,711&ctrl=1073885880&impid=RL7JU199B.JYauA3WlorXA\";var trackingConfigs=adData.trackingConfigs;if(adData.trackingHash={},parent.getClickTracker=getClickTracker,null!=trackingConfigs)for(var i=0;i<trackingConfigs.length;i++){var appender=\"\";switch(1!==parseInt(trackingConfigs[i].data.trackingNumber)&&(appender=trackingConfigs[i].data.trackingNumber),trackingConfigs[i].trackingType){case\"tab\":pushEventType(\"tabClick\"+appender);break;case\"video\":pushEventType(\"videoStart\"+appender),pushEventType(\"videoMidpoint\"+appender),pushEventType(\"videoComplete\"+appender);break;case\"custom\":pushEventType(\"adCustomAction\"+appender);break;default:pushEventType(trackingConfigs[i].trackingType)}}var tarnhelmData=\"undefined\"!=typeof unitData?unitData:adData,trackingConsumer=\"undefined\"!=typeof localUatu?localUatu.trackingConsumer:\"\",clickThrough=\"https://aax-us-east.amazon-adsystem.com/x/c/QkS-yVNffQfyWGrgN1paK1wAAAF8EGnKcAEAAADKAa1-aKg/https://bs.serving-sys.com/Serving/adServer.bs?cn=trd&amp;pli=1077057105&amp;gdpr=&amp;gdpr_consent=&amp;adid=1084725978&amp;ord=7,919,335,811,637,084,900&amp;ctrl=1073885880&amp;impid=RL7JU199B.JYauA3WlorXA\",responsiveImage=\"https://m.media-amazon.com/images/I/71LoJtN9F1L.jpg\",legacyImage=\"\",renderWidth=\"970\",renderHeight=\"250\",backupRenderingSize=\"970x250\";if(window.tarnhelm_backup={appData:tarnhelmData,trackingConsumer:trackingConsumer,clickThrough:clickThrough,target:\"_blank\",responsiveImage:responsiveImage,legacyImage:legacyImage,renderWidth:renderWidth,renderHeight:renderHeight,size:backupRenderingSize,pageBind:\"\",scaleToFull:\"\",slotName:\"\",container:\"\",resizeWrapperWithOverflowHidden:\"\"},window.parent.ad_utils.initAndBindResponsiveBackupLogic(window),document.ad={aid:\"1848988770301\",cid:\"5745144100401\",w:970,h:250,bb:1},isStaticBackUpDevice){var injected_billboard=parent.document.getElementById(\"injected_billboard\");injected_billboard&&(injected_billboard.width=\"970\",injected_billboard.height=\"250\")}<\/script><script type=\"text/javascript\">var iframe=window.frameElement;iframe.style.position=\"relative\";var wrapper=parent.document.getElementById(iframe.id+\"_wrapper\");wrapper&&(wrapper.style.position=\"relative\",wrapper.style.height=\"250px\",wrapper.style.width=\"970px\",wrapper.style.zIndex=50,wrapper.style.overflow=\"visible\",wrapper.style.margin=\"auto\");<\/script><\!-- aid : 1848988770301 : cid : 5745144100401 : template : IMDb Tarnhelm-1.406 --\><\!-- NO [METADATA] --\><script><\/script><script>!function(t,e){var i=function(t){this.type=t.type,this.mode=t.mode,this.attach=t.attach,this.content=t.content,this.clickthru=t.clickthru,this.clickTracker=t.clickTracker,this.target=t.target,this.image=t.image,this.width=t.width,this.height=t.height,this.offsetLeft=t.offsetLeft,this.offsetTop=t.offsetTop,this.zIndex=t.zIndex,this.injectionId=t.injectionId,this.json=t.json,this.clickthru||(this.clickthru=\"https://\"+e.document.location.host),this.zIndex||(this.zIndex=99),this.size=[this.width,this.height],this.offset=[this.offsetLeft,this.offsetTop,this.zIndex]};i.RAW_CONTENT=\"html\",i.IMAGE=\"image\",i.TARNHELM=\"tarnhelm\",i.FLOATER=\"floater\",i.LOGO=\"logo\",i.BOTTOM=\"bottom\",i.TOP=\"top\",i.prototype={load:function(){var o,a,r=\"<style>body{overflow:hidden;margin:0px;background:transparent;}</style>\",s=e.document.getElementById(\"nb20\");if(void 0===t.top.ue_isAdb||\"adblk_yes\"!==t.top.ue_isAdb()){if(s&&(s.style.position=\"relative\"),this.type===i.RAW_CONTENT||this.type===i.TARNHELM)o=this.content;else if(this.type===i.IMAGE){var n=\"(new Image()).src = \'\"+this.clickTracker+\"\';\";o=\'<a href=\"\'+this.clickthru+\'\" target=\"\'+this.target+\'\" onclick=\"\'+n+\'\">\',o+=\'<img src=\"\'+this.image+\'\" height=\"\'+this.height+\'\" width=\"\'+this.width+\'\"/>\',o+=\"</a>\"}if(o){if(r+=o,this.type===i.TARNHELM){var c,h,f=JSON.parse(this.json);f.rect?(c=f.rect.height,h=f.rect.width):f.frameProperties&&f.frameProperties.rect?(c=f.frameProperties.rect.height,h=f.frameProperties.rect.width):f.frameProperties&&f.frameProperties.width&&f.frameProperties.height&&(c=f.frameProperties.height,h=f.frameProperties.width),this.size=[h,c],this.offsetX||f.frameProperties&&f.frameProperties.rect&&f.frameProperties.rect.offsetX&&(this.offsetX=f.frameProperties.rect.offsetX),this.offsetY||f.frameProperties&&f.frameProperties.rect&&f.frameProperties.rect.offsetY&&(this.offsetY=f.frameProperties.rect.offsetY),this.offset=[this.offsetLeft,this.offsetTop,this.zIndex]}if(this.mode===i.FLOATER)a=this.attach===i.BOTTOM?e.generic.insert_after:e.generic.insert_before,e.custom.floater.set(r,this.size,\"none\",this.injectionId,a,this.offset,this.mode);else{var d=e.custom.floater.set(r,this.size,\"none\",this.injectionId,e.generic.insert_after,this.offset,this.mode),m=t.top.document.getElementsByClassName(\"floater_logo\");if(m)for(var l=0;l<m.length;l++)m[l].id!==d&&m[l].parentNode.removeChild(m[l]);setTimeout(function(){var e=t.top.document.getElementById(d);e&&(e.style.position=\"relative\");var i=t.top.document.getElementById(\"home_img\");i&&(i.style.display=\"none\")},50)}if(-1!==location.href.search(\"d=1\")){e.document.getElementById(this.injectionId).addEventListener(\"DOMAttrModified\",function(t){console.log(\"DOMAttrModified\")})}}}}};var o=[],a=function(t){(t.image||t.content)&&o.push(t)},r=function(){e.generic.vanilla_on_document_ready(function(){o.forEach(function(t){t.load()})})};t.Floater=i,t.register_floater=a,t.load_floaters=r}(window,parent);var ua=navigator.userAgent.toLowerCase(),isIpad=ua.indexOf(\"ipad\")>-1||ua.indexOf(\"macintosh\")>-1&&\"ontouchend\"in document,isIe=/MSIE|Trident\\/\\d+/.test(navigator.userAgent),isStaticBackUpDevice=isIe||isIpad;isStaticBackUpDevice||window.register_floater(new Floater({type:\"tarnhelm\",mode:\"logo\",attach:\"bottom\",content:\' <div>\\n <app class=\"th_floater0\"></app>\\n </div>\\n <script type=\"text/javascript\">\\n var ua = navigator.userAgent.toLowerCase();\\nvar isIpad = ua.indexOf(\\\'ipad\\\') > -1 || ua.indexOf(\\\'macintosh\\\') > -1 && \\\'ontouchend\\\' in document;\\n\\nvar isIe = /MSIE|Trident\\\\/\\\\d+/.test(navigator.userAgent);\\n\\n\\nvar isStaticBackUpDevice = isIe || isIpad;\\n\\n if (!isStaticBackUpDevice) {\\n var floaterData = JSON.parse(\\\'{\"id\":\"logo\",\"name\":\"logo\",\"frameProperties\":{\"width\":68,\"height\":56,\"offsetX\":-2,\"offsetY\":-12},\"trackingConfigs\":[{\"componentName\":\"manual-tracking\",\"trackingType\":\"tab\",\"data\":{\"trackingLabel\":\"Manual Tracking\",\"trackingNumber\":1}}],\"assets\":{\"static-logo\":{\"url\":\"https://m.media-amazon.com/images/I/01ZViZ3qUbL.png\"},\"static-logo-hover\":{\"url\":\"https://m.media-amazon.com/images/I/11YAOoELxvL.png\"}},\"children\":[{\"type\":\"rotator\",\"name\":\"logo-rotator\",\"rect\":{\"offsetX\":0,\"offsetY\":0,\"width\":68,\"height\":56},\"activeIndex\":0,\"children\":[{\"type\":\"graphic\",\"name\":\"static-logo\",\"rect\":{\"offsetX\":0,\"offsetY\":0,\"width\":68,\"height\":56},\"asset\":\"static-logo\",\"hoverAsset\":\"static-logo-hover\",\"actions\":{\"click\":[{\"actionName\":\"open-link\",\"data\":{\"url\":\"//www.imdb.com/\",\"sameWindow\":true}}]}}]}]}\\\');\\n floaterData.id = \\\'floater0_3934493620601\\\';\\n floaterData.defaultLink = \"https://www.imdb.com/\";\\n\\n var floaterNode = document.querySelector(\\\'.th_floater0\\\');\\n parent.Tarnhelm.initAdInstance(floaterNode, window.frameElement, floaterData);\\n }\\n <\\/script>\\n\',clickthru:\"https://www.imdb.com/\",clickTracker:getClickTracker(\"adCustomAction20\"),target:\"_top\",image:\"\",width:\"101\",height:\"49\",offsetLeft:\"\",offsetTop:\"\",zIndex:\"\",injectionId:\"home_img\",json:\'{\"id\":\"logo\",\"name\":\"logo\",\"frameProperties\":{\"width\":68,\"height\":56,\"offsetX\":-2,\"offsetY\":-12},\"trackingConfigs\":[{\"componentName\":\"manual-tracking\",\"trackingType\":\"tab\",\"data\":{\"trackingLabel\":\"Manual Tracking\",\"trackingNumber\":1}}],\"assets\":{\"static-logo\":{\"url\":\"https://m.media-amazon.com/images/I/01ZViZ3qUbL.png\"},\"static-logo-hover\":{\"url\":\"https://m.media-amazon.com/images/I/11YAOoELxvL.png\"}},\"children\":[{\"type\":\"rotator\",\"name\":\"logo-rotator\",\"rect\":{\"offsetX\":0,\"offsetY\":0,\"width\":68,\"height\":56},\"activeIndex\":0,\"children\":[{\"type\":\"graphic\",\"name\":\"static-logo\",\"rect\":{\"offsetX\":0,\"offsetY\":0,\"width\":68,\"height\":56},\"asset\":\"static-logo\",\"hoverAsset\":\"static-logo-hover\",\"actions\":{\"click\":[{\"actionName\":\"open-link\",\"data\":{\"url\":\"//www.imdb.com/\",\"sameWindow\":true}}]}}]}]}\'})),document.write(\"<script>window.load_floaters && window.load_floaters();<\\/script>\");<\/script>\n</body></html><\!-- creativeModDate = 1632301354000 --\>\n <div id=\"top_ad_webbug\" style=\"display:none;\">\n <img src=\"https://aax-us-east.amazon-adsystem.com/e/loi/imp?b=IkS-yVNffQfyWGrgN1paK1wAAAF8EGnKiwEAAADKAa1-aKg\" border=\"0\" height=\"1\" width=\"1\" alt=\"\"/>\n <script>\n if (window && window.ue && typeof window.ue.count === \'function\') {\n window.ue.count(\'impressionPixelFired\', 0);\n window.ue.count(\'top_ad_impressionPixelFired\', 0);\n }\n <\/script>\n </div>\n\n');
}
}
...
<a href="/title/tt9071322/?ref_=ttawd_awd_tt"
> <img itemprop="image"
class="poster"
height="98"
width="67"
alt="Dark Waters Poster"
src="https://m.media-amazon.com/images/M/MV5BODQ0M2Y5M2QtZGIwMC00MzJjLThlMzYtNmE3ZTMzZTYzOGEwXkEyXkFqcGdeQXVyMTkxNjUyNQ@@._V1_UX67_CR0,0,67,98_AL_.jpg" />
</a>  <div class="subpage_title_block__right-column">
      <div class="parent">   
        <h3 itemprop="name">
<a href="/title/tt9071322/?ref_=ttawd_awd_tt"
itemprop='url'>Dark Waters</a>             <span class="nobr">
                 (2019)
             </span>
        </h3>
      </div>
...
<div class="header"><div class="nav"><div class="desc">Showing all 0 wins and 10 nominations</div></div></div>  <h3>
    Cinema for Peace Awards
<a href="/event/ev0001568/2020/1?ref_=ttawd_ev_1"
class="event_year" > 2020
</a>  </h3>
        <table class="awards" cellspacing="0" cellpadding="5">
    <tr>
    <td class="title_award_outcome" rowspan="2">
        <b>Nominee</b><br />
        <span class="award_category">Cinema for Peace Award</span>
    </td>
        <td class="award_description">
            Cinema for Peace Award for Justice<br />
        </td>
    </tr>
    <tr>
        <td class="award_description">
            International Green Film Award<br />
        </td>
    </tr>
        </table><br />
  <h3>
    César Awards, France
<a href="/event/ev0000157/2021/1?ref_=ttawd_ev_2"
class="event_year" > 2021
</a>  </h3>
        <table class="awards" cellspacing="0" cellpadding="5">
    <tr>
    <td class="title_award_outcome" rowspan="1">
        <b>Nominee</b><br />
        <span class="award_category">César</span>
    </td>
        <td class="award_description">
            Best Foreign Film (Meilleur film étranger)<br />
        <a href="/name/nm0001331?ref_=ttawd_awd_3"
>Todd Haynes</a>
        <br />
        </td>
    </tr>
...
<a href="/event/ev0005190/2020/1?ref_=ttawd_ev_3"
class="event_year" > 2020
</a>  </h3>
        <table class="awards" cellspacing="0" cellpadding="5">
    <tr>
    <td class="title_award_outcome" rowspan="1">
        <b>Nominee</b><br />
        <span class="award_category">HFCS Award</span>
    </td>
        <td class="award_description">
            Best Adapted Screenplay<br />
        <a href="/name/nm1996352?ref_=ttawd_awd_4"
>Matthew Michael Carnahan</a>
        <br />
        <a href="/name/nm3918350?ref_=ttawd_awd_4"
>Mario Correa</a>
        <br />
        </td>
    </tr>
  ...
  <h3>
    Humanitas Prize
<a href="/event/ev0000337/2020/1?ref_=ttawd_ev_4"
class="event_year" > 2020
</a>  </h3>
        <table class="awards" cellspacing="0" cellpadding="5">
    <tr>
    <td class="title_award_outcome" rowspan="1">
        <b>Nominee</b><br />
        <span class="award_category">Humanitas Prize</span>
    </td>
        <td class="award_description">
            Drama Feature Film<br />
        <a href="/name/nm3918350?ref_=ttawd_awd_5"
>Mario Correa</a>
        <br />
        <a href="/name/nm1996352?ref_=ttawd_awd_5"
>Matthew Michael Carnahan</a>
        <br />
        </td>
    </tr>
  ...
  <h3>
    Satellite Awards
<a href="/event/ev0000296/2019/2?ref_=ttawd_ev_5"
class="event_year" > 2019
</a>  </h3>
        <table class="awards" cellspacing="0" cellpadding="5">
    <tr>
    <td class="title_award_outcome" rowspan="2">
        <b>Nominee</b><br />
        <span class="award_category">Satellite Award</span>
    </td>
        <td class="award_description">
            Best Actor in a Motion Picture, Drama<br />
        <a href="/name/nm0749263?ref_=ttawd_awd_6"
>Mark Ruffalo</a>
        <br />
        </td>
    </tr>
    <tr>
        ...
        <a href="/name/nm1996352?ref_=ttawd_awd_7"
>Matthew Michael Carnahan</a>
        <br />
        <a href="/name/nm3918350?ref_=ttawd_awd_7"
>Mario Correa</a>
        <br />
        <a href="/name/nm10164264?ref_=ttawd_awd_7"
>Nathaniel Rich</a>
        <br />
        </td>
    </tr>
...
<a href="/event/ev0002419/2020/1?ref_=ttawd_ev_6"
class="event_year" > 2020
</a>  </h3>
        <table class="awards" cellspacing="0" cellpadding="5">
    <tr>
    <td class="title_award_outcome" rowspan="1">
        <b>Nominee</b><br />
        <span class="award_category">SIYAD Award</span>
    </td>
        <td class="award_description">
...
11th Place    </div>
  ...
  <h3>
    USC Scripter Award
<a href="/event/ev0000673/2020/1?ref_=ttawd_ev_7"
class="event_year" > 2020
</a>  </h3>
        <table class="awards" cellspacing="0" cellpadding="5">
    <tr>
    <td class="title_award_outcome" rowspan="1">
        <b>Nominee</b><br />
        <span class="award_category">USC Scripter Award</span>
    </td>
        <td class="award_description">
            Film<br />
        <a href="/name/nm1996352?ref_=ttawd_awd_9"
>Matthew Michael Carnahan</a>
            <span class="production_role">(screenwriter)</span>
        <br />
        <a href="/name/nm3918350?ref_=ttawd_awd_9"
>Mario Correa</a>
            <span class="production_role">(screenwriter)</span>
        <br />
        <a href="/name/nm10164264?ref_=ttawd_awd_9"
>Nathaniel Rich</a>
            <span class="production_role">(author)</span>
        <br />
    <div class="award_detail_notes">
            <p class="truncated-note">
Based on the New York Times Magazine article "The Lawyer Who Became DuPont's Worst Nightmare" by <a href="/name/nm10164264?ref_=ttawd_awd_9"></a>...                <a href="javascript: void(0);">More</a>
            </p>
            <p class="full-note">
Based on the New York Times Magazine article "The Lawyer Who Became DuPont's Worst Nightmare" by <a href="/name/nm10164264?ref_=ttawd_awd_9">Nathaniel Rich</a>            </p>
    </div>
        </td>
    </tr>
        </table><br />
...
<a href="/event/ev0003081/2019/1?ref_=ttawd_ev_8"
class="event_year" > 2019
</a>  </h3>
        <table class="awards" cellspacing="0" cellpadding="5">
    <tr>
    <td class="title_award_outcome" rowspan="1">
        <b>Nominee</b><br />
        <span class="award_category">WFCC Award</span>
    </td>
        <td class="award_description">
            Best Actor<br />
        <a href="/name/nm0749263?ref_=ttawd_awd_10"
>Mark Ruffalo</a>
        <br />
        </td>
    </tr>
    ...
    <div class="article" id="see_also">
        ...
        <p>
                        <span class="nobr">
<a href="/title/tt9071322/faq?ref_=ttawd_sa_1"
class="link ghost" >FAQ</a>
    <span class="ghost">|</span></span>                        <span class="nobr">
<a href="/title/tt9071322/reviews?ref_=ttawd_sa_2"
class="link" >User Reviews</a>
    <span class="ghost">|</span></span>                        <span class="nobr">
<a href="/title/tt9071322/ratings?ref_=ttawd_sa_3"
class="link" >User Ratings</a>
    <span class="ghost">|</span></span>                        <span class="nobr">
<a href="/title/tt9071322/externalreviews?ref_=ttawd_sa_4"
class="link" >External Reviews</a>
    <span class="ghost">|</span></span>                        <span class="nobr">
<a href="/title/tt9071322/criticreviews?ref_=ttawd_sa_5"
...
<a href="https://help.imdb.com/article/contribution/contribution-information/adding-data/G6BXD2JFDCCETUF4?ref_=cons_tt_awd_cn_gs_hlp"
>Getting Started</a>
            <span>|</span>
<a href="/czone/?ref_=ttawd_cn_cz"
>Contributor Zone</a>&nbsp;&raquo;</div>
    ...
    <script type="text/javascript">
        window.IMDbAnswersCtaWidget = {
            ...
            queryName: "TitleawdAnswersCtaQuery",
            refToken: "ttawd"
        };
    </script>
    <template id="answersWidgetTemplate">
        ...
        <a href="https://contribute.imdb.com/updates/guide/awards">Please see our guide to updating awards</a>
    </div>
...
if (ad_utils) {
if (ad_utils.set_aax_instrumentation_pixel_url) {
ad_utils.set_aax_instrumentation_pixel_url('TOP_RHS', 'https://aax-us-east.amazon-adsystem.com/x/px/QglBWqvEJW5J1KfxpguNB_QAAAF8EGnKbgEAAADKAacYhXY/');
}
if (ad_utils.inject_serverside_ad) {
ad_utils.inject_serverside_ad('top_rhs', ' <script>document.defaultAd = {h:250,w:300}; document.ad = document.defaultAd;<\/script>\n<script id=\"video-event-handlers\">\n (function(window, document) {\n let SLOT_NAME = \'top_rhs\';\n let videoTargetMap = new Map(); \n let validPlayIndicatorEvents = [\'loadstart\', \'play\'];\n\n function makeId() {\n return Math.random().toString(36).substr(2, 16);\n }\n\n function handleVideoEvent(event) {\n let videoTarget = event.target;\n let eventType = event.type;\n let timestamp = Date.now();\n\n if (videoTarget.nodeName !== \'VIDEO\' || videoTarget.loop) {\n return;\n }\n\n if (!videoTargetMap.has(videoTarget)) {\n let id = makeId();\n videoTargetMap.set(videoTarget, {\n id: id\n });\n videoTarget.id = id;\n }\n\n let videoTargetEventMap = videoTargetMap.get(videoTarget);\n videoTargetEventMap[eventType] = timestamp;\n\n if (eventType === \'ended\') {\n let firedEvents = Object.keys(videoTargetEventMap);\n let hasMatchingPlayEvent = firedEvents.some(function(evt) {\n return validPlayIndicatorEvents.includes(evt);\n });\n if (!hasMatchingPlayEvent) return;\n }\n\n let evt = {\n type: eventType,\n dispatcher: \'video-handler\',\n documentAdString: JSON.stringify(document.ad),\n slotName: SLOT_NAME,\n targetElementId: videoTargetEventMap.id,\n timestamp: timestamp\n };\n\n parent.postMessage(evt, parent.origin);\n }\n\n document.addEventListener(\'loadstart\', handleVideoEvent, true);\n document.addEventListener(\'play\', handleVideoEvent, true);\n document.addEventListener(\'pause\', handleVideoEvent, true);\n document.addEventListener(\'ended\', handleVideoEvent, true);\n })(window, document);\n<\/script>\n <!DOCTYPE html><html><body><\!-- aid : 3903973590301 : cid : 9564073120301 : template : IMDb Static Image-1.710 --\><\!-- NO [METADATA] --\><\!-- Third party Impression Tracking --\><img src=\"https://bs.serving-sys.com/Serving/adServer.bs?cn=display&amp;c=19&amp;pli=1077057103&amp;gdpr=&amp;gdpr_consent=&amp;adid=1084725967&amp;ord=6,711,893,417,139,944,784&amp;ctrl=1073885880&amp;impid=CUFaq8QlbknUp.GmC40H9A\" border=\"0\" width=\"0\" height=\"0\" style=\"display:none;\"><img src=\"https://s.amazon-adsystem.com/iui3?d=forester-did&amp;ex-fargs=%3Fid%3Dae721e3c-16b9-927c-d4ef-3a67bcfd6f35%26type%3D12%26m%3D1&amp;ex-fch=416613&amp;ex-src=https://www.imdb.com/&amp;ex-hargs=v%3D1.0%3Bc%3D1315694470001%3Bp%3DAE721E3C-16B9-927C-D4EF-3A67BCFD6F35\" border=\"0\" width=\"0\" height=\"0\" style=\"display:none;\"><style>.centering-image{margin-left:auto;margin-right:auto;display:block}</style><a href=\"https://aax-us-east.amazon-adsystem.com/x/c/QglBWqvEJW5J1KfxpguNB_QAAAF8EGnKbgEAAADKAacYhXY/https://bs.serving-sys.com/Serving/adServer.bs?cn=trd&amp;pli=1077057103&amp;gdpr=&amp;gdpr_consent=&amp;adid=1084725967&amp;ord=7,745,722,853,143,989,160&amp;ctrl=1073885880&amp;impid=CUFaq8QlbknUp.GmC40H9A\" target=\"_blank\"><img id=\"mobile-ad-image\" class=\"centering-image\" width=\"300\" height=\"250\" border=\"0\" alt=\"Click here\"></a><script>function makeWrapBackgroundStylesCss(e,a){var t=\"(min-width: \"+e+\"px)\",n=\"(max-width: \"+a+\"px)\",r=minWidthToImageMap[e],i=a&&\"\"!==a?\"@media screen and \"+t+\" and \"+n+\" { \":\"@media screen and (min-width: \"+e+\"px) {\";return i+WRAP_BACKGROUND_CSS_SELECTOR+\" {background: url(\"+r+\") scroll top no-repeat !important;\\n\"+scrollBackgroundPositionYCss+\"}}\\n\"}function makeDocumentAdWrapStyle(){if(isStaticBackUpDevice)return null;return null}var WRAP_BACKGROUND_CSS_SELECTOR=\"#ipc-wrap-background-id, #wrapper\",NAVBAR_HEIGHT=56,size=\"300x250\",wrapBackgroundStylesCss=\"\",scrollBackgroundPositionYStyle=\"background-position-y: -\"+NAVBAR_HEIGHT+\"px !important;\",scrollBackgroundPositionYCss=scrollBackgroundPositionYStyle,hasWrapImage=!1,minWidthToImageMap={300:\"\",768:\"\",1024:\"\",1280:\"\"},BACKGROUND_STYLES_300_767=makeWrapBackgroundStylesCss(\"300\",\"767\"),BACKGROUND_STYLES_768_1023=makeWrapBackgroundStylesCss(\"768\",\"1023\"),BACKGROUND_STYLES_1024=makeWrapBackgroundStylesCss(\"1024\",\"\"),BACKGROUND_STYLES_1024_1279=makeWrapBackgroundStylesCss(\"1024\",\"1279\"),BACKGROUND_STYLES_1280=makeWrapBackgroundStylesCss(\"1280\",\"\"),ua=navigator.userAgent.toLowerCase(),isIpad=ua.indexOf(\"ipad\")>-1||ua.indexOf(\"macintosh\")>-1&&\"ontouchend\"in document,isIe=/MSIE|Trident\\/\\d+/.test(navigator.userAgent),isStaticBackUpDevice=isIe||isIpad,wrapColor=\"\";hasWrapImage||!wrapColor||\"970x250\"!==size&&\"300x250\"!==size||(wrapBackgroundStylesCss+=\"\\n\"+WRAP_BACKGROUND_CSS_SELECTOR+\" { background-color: \"+wrapColor+\";}\\n\"),wrapBackgroundStylesCss.length>0&&parent.generic.add_css_style(wrapBackgroundStylesCss,\"wrap-background-styles\"),document.ad={aid:\"3903973590301\",cid:\"9564073120301\",w:\"300\",h:\"250\"},date_checker=function(e){var a,t=new Date((new Date).toDateString()).valueOf(),n=0,r=0,i=0,o=null;for(i=0;i<e.length;i++)try{a=e[i],n=new Date(a.date.replace(/-/g,\"/\")).valueOf(),t>=n&&n>r&&(r=n,o={event:a,index:i})}catch(s){}return o},has_date=function(e){for(i=0;i<e.length;i++)if(e[i].date)return 1;return 0},getDateCheckedEvent=function(e){var a=date_checker(e);return a?a.event:!has_date(e)&&e[0]?e[0]:null},function(e,a,t){var n=[{date:\"2021-09-15\",image:\"https://m.media-amazon.com/images/I/516inOdPV6L.jpg\"}],r=getDateCheckedEvent(n);if(r&&r.image){var i=a.getElementById(\"mobile-ad-image\");i.setAttribute(\"src\",r.image),i.setAttribute(\"data-src\",r.image)}}(window,document,parent);var documentAdWrap=makeDocumentAdWrapStyle();if(documentAdWrap&&(document.ad.wrap=documentAdWrap),window.SFClient){var slot=SFClient.getARID();SFClient.customMessage(\"setPartner\",JSON.stringify({slot:slot,partner:\"1P\"}))}else top&&top.generic&&top.generic.monitoring&&top.generic.monitoring.set_partner&&top.generic.monitoring.set_partner(window,\"1P\"),parent&&parent.ad_utils&&parent.ad_utils.expand_ad(this.frameElement);<\/script>\n</body></html><\!-- creativeModDate = 1632301343000 --\>\n <div id=\"top_rhs_webbug\" style=\"display:none;\">\n <img src=\"https://aax-us-east.amazon-adsystem.com/e/loi/imp?b=IglBWqvEJW5J1KfxpguNB_QAAAF8EGnKggEAAADKAacYhXY\" border=\"0\" height=\"1\" width=\"1\" alt=\"\"/>\n <script>\n if (window && window.ue && typeof window.ue.count === \'function\') {\n window.ue.count(\'impressionPixelFired\', 0);\n window.ue.count(\'top_rhs_impressionPixelFired\', 0);\n }\n <\/script>\n </div>\n\n');
}
}
}, "ad_utils not defined, unable to inject serverside ad");
var videoEvt = {
...
<a href="/title/tt9071322/?ref_=ttawd_ql"
class="subnav_heading" >Dark Waters</a>                <hr/>
...
<a href="/title/tt9071322/awards?ref_=ttawd_ql_1"
class="link" >Awards</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/faq?ref_=ttawd_ql_2"
class="link ghost" >FAQ</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/reviews?ref_=ttawd_ql_3"
class="link" >User Reviews</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/ratings?ref_=ttawd_ql_4"
class="link" >User Ratings</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/externalreviews?ref_=ttawd_ql_5"
class="link" >External Reviews</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/criticreviews?ref_=ttawd_ql_6"
class="link" >Metacritic Reviews</a>
                </li>
    </ul>
    ...
    <ul class="quicklinks">
                <li class="subnav_item_main">
<a href="/title/tt9071322/fullcredits?ref_=ttawd_ql_dt_1"
class="link" >Full Cast and Crew</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/releaseinfo?ref_=ttawd_ql_dt_2"
class="link" >Release Dates</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/officialsites?ref_=ttawd_ql_dt_3"
class="link" >Official Sites</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/companycredits?ref_=ttawd_ql_dt_4"
class="link" >Company Credits</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/locations?ref_=ttawd_ql_dt_5"
class="link" >Filming & Production</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/technical?ref_=ttawd_ql_dt_6"
class="link" >Technical Specs</a>
    ...
    <ul class="quicklinks">
                <li class="subnav_item_main">
<a href="/title/tt9071322/taglines?ref_=ttawd_ql_stry_1"
class="link" >Taglines</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/plotsummary?ref_=ttawd_ql_stry_2"
class="link" >Plot Summary</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/synopsis?ref_=ttawd_ql_stry_3"
class="link" >Synopsis</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/keywords?ref_=ttawd_ql_stry_4"
class="link" >Plot Keywords</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/parentalguide?ref_=ttawd_ql_stry_5"
class="link" >Parents Guide</a>
    ...
    <ul class="quicklinks">
                <li class="subnav_item_main">
<a href="/title/tt9071322/trivia?ref_=ttawd_ql_trv_1"
class="link" >Trivia</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/goofs?ref_=ttawd_ql_trv_2"
class="link" >Goofs</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/crazycredits?ref_=ttawd_ql_trv_3"
class="link" >Crazy Credits</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/quotes?ref_=ttawd_ql_trv_4"
class="link" >Quotes</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/alternateversions?ref_=ttawd_ql_trv_5"
class="link ghost" >Alternate Versions</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/movieconnections?ref_=ttawd_ql_trv_6"
class="link" >Connections</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/soundtrack?ref_=ttawd_ql_trv_7"
class="link" >Soundtracks</a>
    ...
    <ul class="quicklinks">
                <li class="subnav_item_main">
<a href="/title/tt9071322/mediaindex?ref_=ttawd_ql_pv_1"
class="link" >Photo Gallery</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/videogallery?ref_=ttawd_ql_pv_2"
class="link" >Trailers and Videos</a>
    ...
    <ul class="quicklinks">
                <li class="subnav_item_main">
<a href="/title/tt9071322/tvschedule?ref_=ttawd_ql_tv_1"
class="link" >TV Schedule</a>
    ...
    <ul class="quicklinks">
                <li class="subnav_item_main">
<a href="/title/tt9071322/news?ref_=ttawd_ql_rel_1"
class="link" >News</a>
                </li>
                <li class="subnav_item_main">
<a href="/showtimes/title/tt9071322?ref_=ttawd_ql_rel_2"
class="link ghost" >Showtimes</a>
                </li>
                <li class="subnav_item_main">
<a href="/title/tt9071322/externalsites?ref_=ttawd_ql_rel_3"
      ...
      uet("bb", "RelatedListsWidget", {wb: 1});
        ...
        <div class="aux-content-widget-2">
            <div id="relatedListsWidget">
                <div class="rightcornerlink">
                    <a href="/list/create?ref_=ttawd_rls"
...
<a href="/list/ls084754177?ref_=tt_awd_rls_1"
><img height="86" width="86" alt="list image" title="list image" src="https://m.media-amazon.com/images/S/sash/8ZhQrGnWn9cWUVQ.png" class="loadlate hidden " loadlate="https://m.media-amazon.com/images/M/MV5BYTczYTJiNWMtYjQzMC00NWUxLWJmZjYtZGM5ZTYwYWI3Njc4XkEyXkFqcGdeQXVyNjQ2NDMzMTc@._V1_UX86_CR0,0,86,86_AL_.jpg" /></a>        </div>
        <div class="list_name">
            <strong><a href="/list/ls084754177?ref_=tt_awd_rls_1"
>
2021
</a></strong>
        </div>
    ...
    <div class="list-preview odd">
        <div class="list-preview-item-narrow">
<a href="/list/ls076816017?ref_=tt_awd_rls_2"
><img height="86" width="86" alt="list image" title="list image" src="https://m.media-amazon.com/images/S/sash/8ZhQrGnWn9cWUVQ.png" class="loadlate hidden " loadlate="https://m.media-amazon.com/images/M/MV5BMTEwNzM2NjY2MTNeQTJeQWpwZ15BbWU4MDQ3MDI3Njgx._V1_UX86_CR0,0,86,86_AL_.jpg" /></a>        </div>
        <div class="list_name">
            <strong><a href="/list/ls076816017?ref_=tt_awd_rls_2"
>
Must watched
</a></strong>
        </div>
    ...
    <div class="list-preview even">
        <div class="list-preview-item-narrow">
<a href="/list/ls083445615?ref_=tt_awd_rls_3"
><img height="86" width="86" alt="list image" title="list image" src="https://m.media-amazon.com/images/S/sash/8ZhQrGnWn9cWUVQ.png" class="loadlate hidden " loadlate="https://m.media-amazon.com/images/M/MV5BZjdkOTU3MDktN2IxOS00OGEyLWFmMjktY2FiMmZkNWIyODZiXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_UX86_CR0,0,86,86_AL_.jpg" /></a>        </div>
        <div class="list_name">
            <strong><a href="/list/ls083445615?ref_=tt_awd_rls_3"
>
My Best
</a></strong>
        </div>
    ...
    <div class="list-preview odd">
        <div class="list-preview-item-narrow">
<a href="/list/ls084283321?ref_=tt_awd_rls_4"
><img height="86" width="86" alt="list image" title="list image" src="https://m.media-amazon.com/images/S/sash/8ZhQrGnWn9cWUVQ.png" class="loadlate hidden " loadlate="https://m.media-amazon.com/images/M/MV5BYjRmODkzNDItMTNhNi00YjJlLTg0ZjAtODlhZTM0YzgzYThlXkEyXkFqcGdeQXVyNzQ1ODk3MTQ@._V1_UX86_CR0,0,86,86_AL_.jpg" /></a>        </div>
        <div class="list_name">
            <strong><a href="/list/ls084283321?ref_=tt_awd_rls_4"
>
Seen in 2021
</a></strong>
        </div>
    ...
    <div class="list-preview even">
        <div class="list-preview-item-narrow">
<a href="/list/ls045194034?ref_=tt_awd_rls_5"
><img height="86" width="86" alt="list image" title="list image" src="https://m.media-amazon.com/images/S/sash/8ZhQrGnWn9cWUVQ.png" class="loadlate hidden " loadlate="https://m.media-amazon.com/images/M/MV5BMTEzOTY5ODA2MDReQTJeQWpwZ15BbWU4MDI5NDkyMTYz._V1_UX86_CR0,0,86,86_AL_.jpg" /></a>        </div>
        <div class="list_name">
            <strong><a href="/list/ls045194034?ref_=tt_awd_rls_5"
>
Movies - To Watch
</a></strong>
        </div>
        <div class="list_meta">
            a list of 38 titles
            <br />created 07&nbsp;Nov&nbsp;2018
            
        </div>
        <div class="clear">&nbsp;</div>
    </div>
                <div class="see-more">
                    <a href="/lists/tt9071322?ref_=tt_awd_rls_sm"
...
// Track beginning of ad html
if (typeof window.uet === 'function') {
window.uet('bb', 'adplacements:' + 'rhs_cornerstone'.replace(/_/g, ':'), {wb: 1});
}
</script>
...
<iframe title="Advertisement" allowtransparency="true" class="yesScript " data-blank-serverside frameborder="0" id="rhs_cornerstone" marginwidth="0" marginheight="0" name="rhs_cornerstone" onload="doWithAds.call(this, function(){ if(ad_utils && ad_utils.on_ad_load) { ad_utils.on_ad_load(this); }}); " scrolling="no" data-original-width="0" data-original-height="0" width="0" height="0" ></iframe> </div>
<div id="rhs_cornerstone_reflow_helper"></div>
<script id="rhs_cornerstone_rendering">
doWithAds(function() {
if ('cornerstone_slot' == 'cornerstone_slot' && ad_utils && ad_utils.inject_serverside_ad) {
ad_utils.inject_serverside_ad('rhs_cornerstone', '');
} else if ('cornerstone_slot' == 'injected_slot' && ad_utils && ad_utils.inject_ad && ad_utils.inject_ad.register) {
...
if (ad_utils) {
if (ad_utils.set_aax_instrumentation_pixel_url) {
ad_utils.set_aax_instrumentation_pixel_url('INLINE80', 'https://aax-us-east.amazon-adsystem.com/x/px/QpxhV76c7eSux7o0l_CTwpUAAAF8EGnKcAEAAADKAXzijg4/');
}
if (ad_utils.inject_serverside_ad) {
ad_utils.inject_serverside_ad('inline80', ' <script>document.defaultAd = {h:250,w:300}; document.ad = document.defaultAd;<\/script>\n<script id=\"video-event-handlers\">\n (function(window, document) {\n let SLOT_NAME = \'inline80\';\n let videoTargetMap = new Map(); \n let validPlayIndicatorEvents = [\'loadstart\', \'play\'];\n\n function makeId() {\n return Math.random().toString(36).substr(2, 16);\n }\n\n function handleVideoEvent(event) {\n let videoTarget = event.target;\n let eventType = event.type;\n let timestamp = Date.now();\n\n if (videoTarget.nodeName !== \'VIDEO\' || videoTarget.loop) {\n return;\n }\n\n if (!videoTargetMap.has(videoTarget)) {\n let id = makeId();\n videoTargetMap.set(videoTarget, {\n id: id\n });\n videoTarget.id = id;\n }\n\n let videoTargetEventMap = videoTargetMap.get(videoTarget);\n videoTargetEventMap[eventType] = timestamp;\n\n if (eventType === \'ended\') {\n let firedEvents = Object.keys(videoTargetEventMap);\n let hasMatchingPlayEvent = firedEvents.some(function(evt) {\n return validPlayIndicatorEvents.includes(evt);\n });\n if (!hasMatchingPlayEvent) return;\n }\n\n let evt = {\n type: eventType,\n dispatcher: \'video-handler\',\n documentAdString: JSON.stringify(document.ad),\n slotName: SLOT_NAME,\n targetElementId: videoTargetEventMap.id,\n timestamp: timestamp\n };\n\n parent.postMessage(evt, parent.origin);\n }\n\n document.addEventListener(\'loadstart\', handleVideoEvent, true);\n document.addEventListener(\'play\', handleVideoEvent, true);\n document.addEventListener(\'pause\', handleVideoEvent, true);\n document.addEventListener(\'ended\', handleVideoEvent, true);\n })(window, document);\n<\/script>\n <!DOCTYPE html><html><body><\!-- aid : 3903973590301 : cid : 9564073120301 : template : IMDb Static Image-1.710 --\><\!-- NO [METADATA] --\><\!-- Third party Impression Tracking --\><img src=\"https://bs.serving-sys.com/Serving/adServer.bs?cn=display&amp;c=19&amp;pli=1077057103&amp;gdpr=&amp;gdpr_consent=&amp;adid=1084725967&amp;ord=2,922,619,004,548,462,026&amp;ctrl=1073885880&amp;impid=nGFXvpzt5K7HujSX8JPClQ\" border=\"0\" width=\"0\" height=\"0\" style=\"display:none;\"><img src=\"https://s.amazon-adsystem.com/iui3?d=forester-did&amp;ex-fargs=%3Fid%3Dae721e3c-16b9-927c-d4ef-3a67bcfd6f35%26type%3D12%26m%3D1&amp;ex-fch=416613&amp;ex-src=https://www.imdb.com/&amp;ex-hargs=v%3D1.0%3Bc%3D1315694470001%3Bp%3DAE721E3C-16B9-927C-D4EF-3A67BCFD6F35\" border=\"0\" width=\"0\" height=\"0\" style=\"display:none;\"><style>.centering-image{margin-left:auto;margin-right:auto;display:block}</style><a href=\"https://aax-us-east.amazon-adsystem.com/x/c/QpxhV76c7eSux7o0l_CTwpUAAAF8EGnKcAEAAADKAXzijg4/https://bs.serving-sys.com/Serving/adServer.bs?cn=trd&amp;pli=1077057103&amp;gdpr=&amp;gdpr_consent=&amp;adid=1084725967&amp;ord=2,908,134,186,266,658,661&amp;ctrl=1073885880&amp;impid=nGFXvpzt5K7HujSX8JPClQ\" target=\"_blank\"><img id=\"mobile-ad-image\" class=\"centering-image\" width=\"300\" height=\"250\" border=\"0\" alt=\"Click here\"></a><script>function makeWrapBackgroundStylesCss(e,a){var t=\"(min-width: \"+e+\"px)\",n=\"(max-width: \"+a+\"px)\",r=minWidthToImageMap[e],i=a&&\"\"!==a?\"@media screen and \"+t+\" and \"+n+\" { \":\"@media screen and (min-width: \"+e+\"px) {\";return i+WRAP_BACKGROUND_CSS_SELECTOR+\" {background: url(\"+r+\") scroll top no-repeat !important;\\n\"+scrollBackgroundPositionYCss+\"}}\\n\"}function makeDocumentAdWrapStyle(){if(isStaticBackUpDevice)return null;return null}var WRAP_BACKGROUND_CSS_SELECTOR=\"#ipc-wrap-background-id, #wrapper\",NAVBAR_HEIGHT=56,size=\"300x250\",wrapBackgroundStylesCss=\"\",scrollBackgroundPositionYStyle=\"background-position-y: -\"+NAVBAR_HEIGHT+\"px !important;\",scrollBackgroundPositionYCss=scrollBackgroundPositionYStyle,hasWrapImage=!1,minWidthToImageMap={300:\"\",768:\"\",1024:\"\",1280:\"\"},BACKGROUND_STYLES_300_767=makeWrapBackgroundStylesCss(\"300\",\"767\"),BACKGROUND_STYLES_768_1023=makeWrapBackgroundStylesCss(\"768\",\"1023\"),BACKGROUND_STYLES_1024=makeWrapBackgroundStylesCss(\"1024\",\"\"),BACKGROUND_STYLES_1024_1279=makeWrapBackgroundStylesCss(\"1024\",\"1279\"),BACKGROUND_STYLES_1280=makeWrapBackgroundStylesCss(\"1280\",\"\"),ua=navigator.userAgent.toLowerCase(),isIpad=ua.indexOf(\"ipad\")>-1||ua.indexOf(\"macintosh\")>-1&&\"ontouchend\"in document,isIe=/MSIE|Trident\\/\\d+/.test(navigator.userAgent),isStaticBackUpDevice=isIe||isIpad,wrapColor=\"\";hasWrapImage||!wrapColor||\"970x250\"!==size&&\"300x250\"!==size||(wrapBackgroundStylesCss+=\"\\n\"+WRAP_BACKGROUND_CSS_SELECTOR+\" { background-color: \"+wrapColor+\";}\\n\"),wrapBackgroundStylesCss.length>0&&parent.generic.add_css_style(wrapBackgroundStylesCss,\"wrap-background-styles\"),document.ad={aid:\"3903973590301\",cid:\"9564073120301\",w:\"300\",h:\"250\"},date_checker=function(e){var a,t=new Date((new Date).toDateString()).valueOf(),n=0,r=0,i=0,o=null;for(i=0;i<e.length;i++)try{a=e[i],n=new Date(a.date.replace(/-/g,\"/\")).valueOf(),t>=n&&n>r&&(r=n,o={event:a,index:i})}catch(s){}return o},has_date=function(e){for(i=0;i<e.length;i++)if(e[i].date)return 1;return 0},getDateCheckedEvent=function(e){var a=date_checker(e);return a?a.event:!has_date(e)&&e[0]?e[0]:null},function(e,a,t){var n=[{date:\"2021-09-15\",image:\"https://m.media-amazon.com/images/I/516inOdPV6L.jpg\"}],r=getDateCheckedEvent(n);if(r&&r.image){var i=a.getElementById(\"mobile-ad-image\");i.setAttribute(\"src\",r.image),i.setAttribute(\"data-src\",r.image)}}(window,document,parent);var documentAdWrap=makeDocumentAdWrapStyle();if(documentAdWrap&&(document.ad.wrap=documentAdWrap),window.SFClient){var slot=SFClient.getARID();SFClient.customMessage(\"setPartner\",JSON.stringify({slot:slot,partner:\"1P\"}))}else top&&top.generic&&top.generic.monitoring&&top.generic.monitoring.set_partner&&top.generic.monitoring.set_partner(window,\"1P\"),parent&&parent.ad_utils&&parent.ad_utils.expand_ad(this.frameElement);<\/script>\n</body></html><\!-- creativeModDate = 1632301343000 --\>\n <div id=\"inline80_webbug\" style=\"display:none;\">\n <img src=\"https://aax-us-east.amazon-adsystem.com/e/loi/imp?b=IpxhV76c7eSux7o0l_CTwpUAAAF8EGnKhgEAAADKAXzijg4\" border=\"0\" height=\"1\" width=\"1\" alt=\"\"/>\n <script>\n if (window && window.ue && typeof window.ue.count === \'function\') {\n window.ue.count(\'impressionPixelFired\', 0);\n window.ue.count(\'inline80_impressionPixelFired\', 0);\n }\n <\/script>\n </div>\n\n');
}
}
}, "ad_utils not defined, unable to inject serverside ad");
var videoEvt = {
...
<!-- End INLINE80 -->
  ...
  <a onclick="window.open(&quot;https://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.imdb.com%2Ftitle%2Ftt9071322%2F&quot;, 'newWindow', 'width=626, height=436'); return false;" href="https://www.facebook.com/sharer.php?u=http%3A%2F%2Fwww.imdb.com%2Ftitle%2Ftt9071322%2F" target="_blank" title="Share on Facebook" class="share_icon facebook"></a>
  <a onclick="window.open(&quot;https://twitter.com/intent/tweet?text=Dark%20Waters%20-%20https%3A%2F%2Fwww.imdb.com%2Ftitle%2Ftt9071322%2F&quot;, 'newWindow', 'width=815, height=436'); return false;" href="https://twitter.com/intent/tweet?text=Dark%20Waters%20-%20https%3A%2F%2Fwww.imdb.com%2Ftitle%2Ftt9071322%2F" target="_blank" title="Share on Twitter" class="share_icon twitter"></a>
  <a onclick="$('div.social input[name=share-link]').show().select(); return false;" title="Share the page" class="share_icon share_url_link" href="http://www.imdb.com/title/tt9071322/"></a>
      </div>
      <input type="text" name="share-link" value="https://www.imdb.com/title/tt9071322/" readonly>
    </div>
  </div>
...
if (ad_utils) {
if (ad_utils.set_aax_instrumentation_pixel_url) {
ad_utils.set_aax_instrumentation_pixel_url('BTF_RHS2', 'https://aax-us-east.amazon-adsystem.com/x/px/QjXQLaI5WZ8f_-hDIXUoizwAAAF8EGnKbwEAAADKAXR-nlE/');
}
if (ad_utils.inject_serverside_ad) {
ad_utils.inject_serverside_ad('btf_rhs2', ' <script>document.defaultAd = {h:250,w:300}; document.ad = document.defaultAd;<\/script>\n<script id=\"video-event-handlers\">\n (function(window, document) {\n let SLOT_NAME = \'btf_rhs2\';\n let videoTargetMap = new Map(); \n let validPlayIndicatorEvents = [\'loadstart\', \'play\'];\n\n function makeId() {\n return Math.random().toString(36).substr(2, 16);\n }\n\n function handleVideoEvent(event) {\n let videoTarget = event.target;\n let eventType = event.type;\n let timestamp = Date.now();\n\n if (videoTarget.nodeName !== \'VIDEO\' || videoTarget.loop) {\n return;\n }\n\n if (!videoTargetMap.has(videoTarget)) {\n let id = makeId();\n videoTargetMap.set(videoTarget, {\n id: id\n });\n videoTarget.id = id;\n }\n\n let videoTargetEventMap = videoTargetMap.get(videoTarget);\n videoTargetEventMap[eventType] = timestamp;\n\n if (eventType === \'ended\') {\n let firedEvents = Object.keys(videoTargetEventMap);\n let hasMatchingPlayEvent = firedEvents.some(function(evt) {\n return validPlayIndicatorEvents.includes(evt);\n });\n if (!hasMatchingPlayEvent) return;\n }\n\n let evt = {\n type: eventType,\n dispatcher: \'video-handler\',\n documentAdString: JSON.stringify(document.ad),\n slotName: SLOT_NAME,\n targetElementId: videoTargetEventMap.id,\n timestamp: timestamp\n };\n\n parent.postMessage(evt, parent.origin);\n }\n\n document.addEventListener(\'loadstart\', handleVideoEvent, true);\n document.addEventListener(\'play\', handleVideoEvent, true);\n document.addEventListener(\'pause\', handleVideoEvent, true);\n document.addEventListener(\'ended\', handleVideoEvent, true);\n })(window, document);\n<\/script>\n <!DOCTYPE html><html><body><\!-- aid : 3903973590301 : cid : 9564073120301 : template : IMDb Static Image-1.710 --\><\!-- NO [METADATA] --\><\!-- Third party Impression Tracking --\><img src=\"https://bs.serving-sys.com/Serving/adServer.bs?cn=display&amp;c=19&amp;pli=1077057103&amp;gdpr=&amp;gdpr_consent=&amp;adid=1084725967&amp;ord=9,022,286,781,972,987,514&amp;ctrl=1073885880&amp;impid=NdAtojlZnx..6EMhdSiLPA\" border=\"0\" width=\"0\" height=\"0\" style=\"display:none;\"><img src=\"https://s.amazon-adsystem.com/iui3?d=forester-did&amp;ex-fargs=%3Fid%3Dae721e3c-16b9-927c-d4ef-3a67bcfd6f35%26type%3D12%26m%3D1&amp;ex-fch=416613&amp;ex-src=https://www.imdb.com/&amp;ex-hargs=v%3D1.0%3Bc%3D1315694470001%3Bp%3DAE721E3C-16B9-927C-D4EF-3A67BCFD6F35\" border=\"0\" width=\"0\" height=\"0\" style=\"display:none;\"><style>.centering-image{margin-left:auto;margin-right:auto;display:block}</style><a href=\"https://aax-us-east.amazon-adsystem.com/x/c/QjXQLaI5WZ8f_-hDIXUoizwAAAF8EGnKbwEAAADKAXR-nlE/https://bs.serving-sys.com/Serving/adServer.bs?cn=trd&amp;pli=1077057103&amp;gdpr=&amp;gdpr_consent=&amp;adid=1084725967&amp;ord=1,564,935,746,767,880,168&amp;ctrl=1073885880&amp;impid=NdAtojlZnx..6EMhdSiLPA\" target=\"_blank\"><img id=\"mobile-ad-image\" class=\"centering-image\" width=\"300\" height=\"250\" border=\"0\" alt=\"Click here\"></a><script>function makeWrapBackgroundStylesCss(e,a){var t=\"(min-width: \"+e+\"px)\",n=\"(max-width: \"+a+\"px)\",r=minWidthToImageMap[e],i=a&&\"\"!==a?\"@media screen and \"+t+\" and \"+n+\" { \":\"@media screen and (min-width: \"+e+\"px) {\";return i+WRAP_BACKGROUND_CSS_SELECTOR+\" {background: url(\"+r+\") scroll top no-repeat !important;\\n\"+scrollBackgroundPositionYCss+\"}}\\n\"}function makeDocumentAdWrapStyle(){if(isStaticBackUpDevice)return null;return null}var WRAP_BACKGROUND_CSS_SELECTOR=\"#ipc-wrap-background-id, #wrapper\",NAVBAR_HEIGHT=56,size=\"300x250\",wrapBackgroundStylesCss=\"\",scrollBackgroundPositionYStyle=\"background-position-y: -\"+NAVBAR_HEIGHT+\"px !important;\",scrollBackgroundPositionYCss=scrollBackgroundPositionYStyle,hasWrapImage=!1,minWidthToImageMap={300:\"\",768:\"\",1024:\"\",1280:\"\"},BACKGROUND_STYLES_300_767=makeWrapBackgroundStylesCss(\"300\",\"767\"),BACKGROUND_STYLES_768_1023=makeWrapBackgroundStylesCss(\"768\",\"1023\"),BACKGROUND_STYLES_1024=makeWrapBackgroundStylesCss(\"1024\",\"\"),BACKGROUND_STYLES_1024_1279=makeWrapBackgroundStylesCss(\"1024\",\"1279\"),BACKGROUND_STYLES_1280=makeWrapBackgroundStylesCss(\"1280\",\"\"),ua=navigator.userAgent.toLowerCase(),isIpad=ua.indexOf(\"ipad\")>-1||ua.indexOf(\"macintosh\")>-1&&\"ontouchend\"in document,isIe=/MSIE|Trident\\/\\d+/.test(navigator.userAgent),isStaticBackUpDevice=isIe||isIpad,wrapColor=\"\";hasWrapImage||!wrapColor||\"970x250\"!==size&&\"300x250\"!==size||(wrapBackgroundStylesCss+=\"\\n\"+WRAP_BACKGROUND_CSS_SELECTOR+\" { background-color: \"+wrapColor+\";}\\n\"),wrapBackgroundStylesCss.length>0&&parent.generic.add_css_style(wrapBackgroundStylesCss,\"wrap-background-styles\"),document.ad={aid:\"3903973590301\",cid:\"9564073120301\",w:\"300\",h:\"250\"},date_checker=function(e){var a,t=new Date((new Date).toDateString()).valueOf(),n=0,r=0,i=0,o=null;for(i=0;i<e.length;i++)try{a=e[i],n=new Date(a.date.replace(/-/g,\"/\")).valueOf(),t>=n&&n>r&&(r=n,o={event:a,index:i})}catch(s){}return o},has_date=function(e){for(i=0;i<e.length;i++)if(e[i].date)return 1;return 0},getDateCheckedEvent=function(e){var a=date_checker(e);return a?a.event:!has_date(e)&&e[0]?e[0]:null},function(e,a,t){var n=[{date:\"2021-09-15\",image:\"https://m.media-amazon.com/images/I/516inOdPV6L.jpg\"}],r=getDateCheckedEvent(n);if(r&&r.image){var i=a.getElementById(\"mobile-ad-image\");i.setAttribute(\"src\",r.image),i.setAttribute(\"data-src\",r.image)}}(window,document,parent);var documentAdWrap=makeDocumentAdWrapStyle();if(documentAdWrap&&(document.ad.wrap=documentAdWrap),window.SFClient){var slot=SFClient.getARID();SFClient.customMessage(\"setPartner\",JSON.stringify({slot:slot,partner:\"1P\"}))}else top&&top.generic&&top.generic.monitoring&&top.generic.monitoring.set_partner&&top.generic.monitoring.set_partner(window,\"1P\"),parent&&parent.ad_utils&&parent.ad_utils.expand_ad(this.frameElement);<\/script>\n</body></html><\!-- creativeModDate = 1632301343000 --\>\n <div id=\"btf_rhs2_webbug\" style=\"display:none;\">\n <img src=\"https://aax-us-east.amazon-adsystem.com/e/loi/imp?b=IjXQLaI5WZ8f_-hDIXUoizwAAAF8EGnKgwEAAADKAXR-nlE\" border=\"0\" height=\"1\" width=\"1\" alt=\"\"/>\n <script>\n if (window && window.ue && typeof window.ue.count === \'function\') {\n window.ue.count(\'impressionPixelFired\', 0);\n window.ue.count(\'btf_rhs2_impressionPixelFired\', 0);\n }\n <\/script>\n </div>\n\n');
}
}
}, "ad_utils not defined, unable to inject serverside ad");
var videoEvt = {
...
if (ad_utils) {
if (ad_utils.set_aax_instrumentation_pixel_url) {
ad_utils.set_aax_instrumentation_pixel_url('BOTTOM_AD', 'https://aax-us-east.amazon-adsystem.com/x/px/Qn3eGVEeJRjAkTjta3SymVgAAAF8EGnKcQEAAADKAbtg7ms/');
}
if (ad_utils.inject_serverside_ad) {
ad_utils.inject_serverside_ad('bottom_ad', ' <script>document.defaultAd = {h:90,w:728}; document.ad = document.defaultAd;<\/script>\n<script id=\"video-event-handlers\">\n (function(window, document) {\n let SLOT_NAME = \'bottom_ad\';\n let videoTargetMap = new Map(); \n let validPlayIndicatorEvents = [\'loadstart\', \'play\'];\n\n function makeId() {\n return Math.random().toString(36).substr(2, 16);\n }\n\n function handleVideoEvent(event) {\n let videoTarget = event.target;\n let eventType = event.type;\n let timestamp = Date.now();\n\n if (videoTarget.nodeName !== \'VIDEO\' || videoTarget.loop) {\n return;\n }\n\n if (!videoTargetMap.has(videoTarget)) {\n let id = makeId();\n videoTargetMap.set(videoTarget, {\n id: id\n });\n videoTarget.id = id;\n }\n\n let videoTargetEventMap = videoTargetMap.get(videoTarget);\n videoTargetEventMap[eventType] = timestamp;\n\n if (eventType === \'ended\') {\n let firedEvents = Object.keys(videoTargetEventMap);\n let hasMatchingPlayEvent = firedEvents.some(function(evt) {\n return validPlayIndicatorEvents.includes(evt);\n });\n if (!hasMatchingPlayEvent) return;\n }\n\n let evt = {\n type: eventType,\n dispatcher: \'video-handler\',\n documentAdString: JSON.stringify(document.ad),\n slotName: SLOT_NAME,\n targetElementId: videoTargetEventMap.id,\n timestamp: timestamp\n };\n\n parent.postMessage(evt, parent.origin);\n }\n\n document.addEventListener(\'loadstart\', handleVideoEvent, true);\n document.addEventListener(\'play\', handleVideoEvent, true);\n document.addEventListener(\'pause\', handleVideoEvent, true);\n document.addEventListener(\'ended\', handleVideoEvent, true);\n })(window, document);\n<\/script>\n <!DOCTYPE html><html><body><\!-- aid : 1848988770301 : cid : 2428204170101 : template : IMDb Static Image-1.710 --\><\!-- NO [METADATA] --\><\!-- Third party Impression Tracking --\><img src=\"https://bs.serving-sys.com/Serving/adServer.bs?cn=display&amp;c=19&amp;pli=1077057105&amp;gdpr=&amp;gdpr_consent=&amp;adid=1084725978&amp;ord=6,708,510,709,980,979,761&amp;ctrl=1073885880&amp;impid=fd4ZUR4lGMCROO1rdLKZWA\" border=\"0\" width=\"0\" height=\"0\" style=\"display:none;\"><img src=\"https://s.amazon-adsystem.com/iui3?d=forester-did&amp;ex-fargs=%3Fid%3Dae721e3c-16b9-927c-d4ef-3a67bcfd6f35%26type%3D12%26m%3D1&amp;ex-fch=416613&amp;ex-src=https://www.imdb.com/&amp;ex-hargs=v%3D1.0%3Bc%3D1315694470001%3Bp%3DAE721E3C-16B9-927C-D4EF-3A67BCFD6F35\" border=\"0\" width=\"0\" height=\"0\" style=\"display:none;\"><style>.centering-image{margin-left:auto;margin-right:auto;display:block}</style><a href=\"https://aax-us-east.amazon-adsystem.com/x/c/Qn3eGVEeJRjAkTjta3SymVgAAAF8EGnKcQEAAADKAbtg7ms/https://bs.serving-sys.com/Serving/adServer.bs?cn=trd&amp;pli=1077057105&amp;gdpr=&amp;gdpr_consent=&amp;adid=1084725978&amp;ord=7,057,452,705,670,790,659&amp;ctrl=1073885880&amp;impid=fd4ZUR4lGMCROO1rdLKZWA\" target=\"_blank\"><img id=\"mobile-ad-image\" class=\"centering-image\" width=\"728\" height=\"90\" border=\"0\" alt=\"Click here\"></a><script>function makeWrapBackgroundStylesCss(e,a){var t=\"(min-width: \"+e+\"px)\",n=\"(max-width: \"+a+\"px)\",r=minWidthToImageMap[e],i=a&&\"\"!==a?\"@media screen and \"+t+\" and \"+n+\" { \":\"@media screen and (min-width: \"+e+\"px) {\";return i+WRAP_BACKGROUND_CSS_SELECTOR+\" {background: url(\"+r+\") scroll top no-repeat !important;\\n\"+scrollBackgroundPositionYCss+\"}}\\n\"}function makeDocumentAdWrapStyle(){if(isStaticBackUpDevice)return null;return null}var WRAP_BACKGROUND_CSS_SELECTOR=\"#ipc-wrap-background-id, #wrapper\",NAVBAR_HEIGHT=56,size=\"728x90\",wrapBackgroundStylesCss=\"\",scrollBackgroundPositionYStyle=\"background-position-y: -\"+NAVBAR_HEIGHT+\"px !important;\",scrollBackgroundPositionYCss=scrollBackgroundPositionYStyle,hasWrapImage=!1,minWidthToImageMap={300:\"\",768:\"\",1024:\"\",1280:\"\"},BACKGROUND_STYLES_300_767=makeWrapBackgroundStylesCss(\"300\",\"767\"),BACKGROUND_STYLES_768_1023=makeWrapBackgroundStylesCss(\"768\",\"1023\"),BACKGROUND_STYLES_1024=makeWrapBackgroundStylesCss(\"1024\",\"\"),BACKGROUND_STYLES_1024_1279=makeWrapBackgroundStylesCss(\"1024\",\"1279\"),BACKGROUND_STYLES_1280=makeWrapBackgroundStylesCss(\"1280\",\"\"),ua=navigator.userAgent.toLowerCase(),isIpad=ua.indexOf(\"ipad\")>-1||ua.indexOf(\"macintosh\")>-1&&\"ontouchend\"in document,isIe=/MSIE|Trident\\/\\d+/.test(navigator.userAgent),isStaticBackUpDevice=isIe||isIpad,wrapColor=\"\";hasWrapImage||!wrapColor||\"970x250\"!==size&&\"300x250\"!==size||(wrapBackgroundStylesCss+=\"\\n\"+WRAP_BACKGROUND_CSS_SELECTOR+\" { background-color: \"+wrapColor+\";}\\n\"),wrapBackgroundStylesCss.length>0&&parent.generic.add_css_style(wrapBackgroundStylesCss,\"wrap-background-styles\"),document.ad={aid:\"1848988770301\",cid:\"2428204170101\",w:\"728\",h:\"90\"},date_checker=function(e){var a,t=new Date((new Date).toDateString()).valueOf(),n=0,r=0,i=0,o=null;for(i=0;i<e.length;i++)try{a=e[i],n=new Date(a.date.replace(/-/g,\"/\")).valueOf(),t>=n&&n>r&&(r=n,o={event:a,index:i})}catch(s){}return o},has_date=function(e){for(i=0;i<e.length;i++)if(e[i].date)return 1;return 0},getDateCheckedEvent=function(e){var a=date_checker(e);return a?a.event:!has_date(e)&&e[0]?e[0]:null},function(e,a,t){var n=[{date:\"2021-09-15\",image:\"https://m.media-amazon.com/images/I/51A2EGafhpL.jpg\"}],r=getDateCheckedEvent(n);if(r&&r.image){var i=a.getElementById(\"mobile-ad-image\");i.setAttribute(\"src\",r.image),i.setAttribute(\"data-src\",r.image)}}(window,document,parent);var documentAdWrap=makeDocumentAdWrapStyle();if(documentAdWrap&&(document.ad.wrap=documentAdWrap),window.SFClient){var slot=SFClient.getARID();SFClient.customMessage(\"setPartner\",JSON.stringify({slot:slot,partner:\"1P\"}))}else top&&top.generic&&top.generic.monitoring&&top.generic.monitoring.set_partner&&top.generic.monitoring.set_partner(window,\"1P\"),parent&&parent.ad_utils&&parent.ad_utils.expand_ad(this.frameElement);<\/script>\n</body></html><\!-- creativeModDate = 1632214928000 --\>\n <div id=\"bottom_ad_webbug\" style=\"display:none;\">\n <img src=\"https://aax-us-east.amazon-adsystem.com/e/loi/imp?b=In3eGVEeJRjAkTjta3SymVgAAAF8EGnKhgEAAADKAbtg7ms\" border=\"0\" height=\"1\" width=\"1\" alt=\"\"/>\n <script>\n if (window && window.ue && typeof window.ue.count === \'function\') {\n window.ue.count(\'impressionPixelFired\', 0);\n window.ue.count(\'bottom_ad_impressionPixelFired\', 0);\n }\n <\/script>\n </div>\n\n');
}
}
}, "ad_utils not defined, unable to inject serverside ad");
var videoEvt = {
...
<script>
    ...
    <div id="73c31242-1fca-4644-aac4-76ab57e249c2">
...
<script type="text/javascript">
    if (!window.RadWidget) {
        ...
        window['RadWidget'].registerReactWidgetInstance({
            ...
            instanceId: "73c31242-1fca-4644-aac4-76ab57e249c2",
            model: {"ResponsiveFooterModel":{"desktopLink":"?mode=desktop&ref_=m_ft_dsk","showDesktopLink":true}}
        });
    </script>
<script>
    if (typeof uet == 'function') {
...
<script type="text/javascript" src="https://m.media-amazon.com/images/S/sash/sOtmKjynEgw9I96.js"></script>
           ...
           var isAdvertisingThemed = !!(window.custom && window.custom.full_page && window.custom.full_page.theme),
               url = "https://www.facebook.com/widgets/like.php?width=280&show_faces=1&layout=standard&href=http%3A%2F%2Fwww.imdb.com%2Ftitle%2Ftt9071322%2F&colorscheme=light",
            ...
            branch.init('key_live_jdSfREMXW6WE9FcCt5HWFbhgswmprlIn', { timeout: 2000 }, (err, data) => {
                ...
                if (err) {
                    ...
                    branch.setBranchViewData(
                        {
                            data: {
                                '$deeplink_path': '\/title/tt9071322/awards'
                            }
                        }
                    );
                    branch.setIdentity('133-0822304-5101768', (err, data) => {
                        if (err) {
...
if (window.csa) {
    csa("Events")("setEntity", {
        page:{pageType: "title", subPageType: "awards", pageTypeId: ""}
    });
}
...
<noscript>
    <img height="1" width="1" style='display:none;visibility:hidden;' src='//fls-na.amazon.com/1/batch/1/OP/A1EVAM02EL8SFB:133-0822304-5101768:X1VV16GWPAT7S8ZESC5G$uedata=s:%2Frd%2Fuedata%3Fnoscript%26id%3DX1VV16GWPAT7S8ZESC5G:0' alt=""/>
</noscript>

<script>window.ue && ue.count && ue.count('CSMLibrarySize', 43535)</script>
    </body>
</html>
